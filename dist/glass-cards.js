...
`;let $t=class extends dt{setConfig(t){this._config={title:"Home",entities:[],...t}}getCardSize(){return 2}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{title:"Home",entities:[]}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||this._config.entities.some(t=>e.states[t]!==this.hass.states[t])}_statusOf(t){const e=this.hass?.states[t];if(!e)return{label:"Unknown",home:!1,accent:"var(--g-dim)"};if("home"===e.state)return{label:"Home",home:!0,accent:"var(--g-green)"};if("not_home"===e.state)return{label:"Away",home:!1,accent:"var(--g-dim)"};return{label:e.state.charAt(0).toUpperCase()+e.state.slice(1),home:!1,accent:"var(--g-amber)"}}_relTime(t){if(!t)return"";const e=Math.round((Date.now()-new Date(t).getTime())/6e4);if(e<1)return"just now";if(e<60)return`${e}m ago`;const i=Math.round(e/60);return i<24?`${i}h ago`:`${Math.round(i/24)}d ago`}_open(t){xt(this,"hass-more-info",{entityId:t})}render(){if(!this._config||!this.hass)return Y;if(!this._config.entities.length)return yt("Add person entities","group");const t=this._config.entities.map(t=>({id:t,st:this.hass.states[t]})),e=t.filter(t=>"home"===t.st?.state).length;return q`
    ...
    `],e([mt({attribute:!1})],Nt.prototype,"hass",void 0),e([ft()],Nt.prototype,"_config",void 0),e([ft()],Nt.prototype,"_code",void 0),Nt=e([pt("glass-alarm-card")],Nt);const Mt=[["#7dd68a","var(--g-green)"],["#e0b24a","var(--g-amber)"],["#a97ff0","var(--g-purple)"],["#5ab9bd","var(--g-cyan)"]];let Pt=class extends dt{constructor(){super(...arguments),this._bars=[]}setConfig(t){this._config={title:"Energy",variant:"flow",...t},this._fetchedFor=void 0}getCardSize(){const t=this._config?.variant;return"flow"===t||"production"===t?4:"strip"===t||"bar"===t?1:3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{title:"Energy",variant:"flow",solar:"sensor.solar_power",grid:"sensor.grid_power",battery:"sensor.battery_power"}}shouldUpdate(t){if(t.has("_config")||t.has("_bars"))return!0;const e=t.get("hass");if(!e||!this.hass||!this._config)return!0;const i=this._config;return[i.solar,i.grid,i.battery,i.battery_soc,i.house,i.today,i.imported,i.exported,i.saved,i.production,...i.meters??[]].filter(Boolean).some(t=>e.states[t]!==this.hass.states[t])}updated(){if(!this.hass||!this._config||"production"!==this._config.variant||!this._config.production)return;const t=this.hass.states[this._config.production];t&&t.last_updated!==this._fetchedFor&&(this._fetchedFor=t.last_updated,this._loadProduction(this._config.production))}async _loadProduction(t){const e=new Date;e.setHours(0,0,0,0);try{const i=(await this.hass.callWS({type:"recorder/statistics_during_period",start_time:e.toISOString(),statistic_ids:[t],period:"hour"}))[t]??[];this._bars=i.map(t=>({v:Math.max(0,Number(t.change??t.state??0)),label:String(new Date(Number(t.start)).getHours())}))}catch{this._bars=[]}}_watts(t){if(!t||!this.hass)return null;const e=this.hass.states[t];if(!e||"unavailable"===e.state||"unknown"===e.state)return null;const i=Number(e.state);if(Number.isNaN(i))return null;return"kw"===String(e.attributes.unit_of_measurement??"").toLowerCase()?1e3*i:i}_kw(t){return(t/1e3).toFixed(1)}_stateNum(t){const e=t?Number(this.hass.states[t]?.state):NaN;return Number.isNaN(e)?null:e}_label(t){return this.hass.states[t]?.attributes.friendly_name??t}render(){if(!this._config||!this.hass)return Y;switch(this._config.variant){case"ring":return this._renderRing();case"stats":return this._renderStats();case"meters":return this._renderMeters();case"production":return this._renderProduction();case"strip":return this._renderStrip();case"bar":return this._renderBar();default:return this._renderFlow()}}_head(t){return q`<div class="hdr"><div class="hdr-l">${_t("bolt",22,"var(--g-amber)")}<span class="title">${this._config.title}</span></div>${t??Y}</div>`}_renderFlow(){const t=this._watts(this._config.solar),e=this._watts(this._config.grid),i=this._watts(this._config.battery);let s=this._watts(this._config.house);null==s&&(s=(t??0)+(e??0)+(i??0));const a=this._stateNum(this._config.battery_soc),r=(t??0)>20,n=(e??0)>20,o=(e??0)<-20,l=(i??0)>20,c=(i??0)<-20,d=o?{label:"Exporting",purple:!1}:n?{label:"Grid import",purple:!0}:{label:"Self-powered",purple:!1},g=(t,e,i=!1)=>t?`stroke:${e};animation:g-flow 0.7s linear infinite${i?" reverse":""};`:"stroke:rgba(255,255,255,0.06);";return q`<div class="card">
      ...
      ${this._head()}
      <div class="meters">
        ${e.map((e,i)=>{const s=Math.max(0,Math.min(100,this._stateNum(e)??0)),[a,r]=Mt[i%Mt.length];return q`<div class="m">
    ...
    </div>`}_renderStrip(){const t=this._config,e=this._watts(t.solar),i=this._watts(t.grid);let s=this._watts(t.house);null==s&&(s=(e??0)+(i??0)+(this._watts(t.battery)??0));const a=this._stateNum(t.battery_soc);return q`<div class="card strip">
      ${null!=a?q`<div class="soc-ring" style="background:conic-gradient(var(--g-amber) 0 ${a}%, rgba(255,255,255,0.08) ${a}% 100%)">
            <div class="soc-in">${Math.round(a)}%</div>
          </div>`:Y}
      <div class="strip-stats">
        <div class="ss"><div class="ss-h">${_t("solar_power",14,"var(--g-amber)")}Solar</div><div class="ss-v">${null!=e?this._kw(e):"—"} kW</div></div>
        <div class="ss"><div class="ss-h">${_t("home",14,"var(--g-amber)")}Load</div><div class="ss-v">${null!=s?Math.round(s):"—"} W</div></div>
        <div class="ss"><div class="ss-h">${_t("bolt",14,"var(--g-purple)")}Grid</div><div class="ss-v">${null!=i?this._kw(Math.abs(i)):"—"} kW</div></div>
      </div>
    </div>`}_renderBar(){const t=this._config,e=Math.max(0,this._watts(t.solar)??0),i=this._watts(t.battery)??0,s=e+(i>0?i:0),a=s>0?Math.round(e/s*100):0,r=s>0?100-a:0,n=this._watts(t.grid),o=(n??0)>20?"Grid import":(n??0)<-20?"Exporting":"Self-powered";return q`<div class="card bar-card">
      <div class="bar-hdr">
        <div class="hdr-l">${_t("bolt",20,"var(--g-amber)")}<span class="title">${t.title}</span></div>
        <span class="bar-status ${"Self-powered"===o||"Exporting"===o?"green":""}">${o}</span>
      </div>
      <div class="mix">
        <span style="width:${a}%;background:linear-gradient(90deg,var(--g-amber-deep),var(--g-amber))"></span>
        <span style="width:${r}%;background:var(--g-cyan)"></span>
      </div>
      <div class="mix-legend">
        <span><span class="d" style="color:var(--g-amber)">●</span> Solar ${a}%</span>
        <span><span class="d" style="color:var(--g-cyan)">●</span> Battery ${r}%</span>
      </div>
    </div>`}};Pt.styles=[wt,o`
    ...
    `],e([mt({attribute:!1})],Pt.prototype,"hass",void 0),e([ft()],Pt.prototype,"_config",void 0),e([ft()],Pt.prototype,"_bars",void 0),Pt=e([pt("glass-energy-card")],Pt);const jt=new Set(["light","switch","fan","input_boolean","automation","script","siren","humidifier"]),Ot={light:"lightbulb",switch:"toggle_on",fan:"mode_fan",climate:"thermostat",cover:"garage",lock:"lock",media_player:"speaker",script:"play_arrow",automation:"bolt",humidifier:"humidity_high",vacuum:"cleaning_services"},Lt={temperature:"thermostat",humidity:"water_drop",pressure:"compress",power:"bolt",energy:"bolt",battery:"battery_full",illuminance:"light_mode",motion:"sensors",door:"sensor_door",window:"window",co2:"co2"};let Ut=class extends dt{setConfig(t){this._config=t}getCardSize(){return 1}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entity:""}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||e.states[this._config.entity]!==this.hass.states[this._config.entity]}get _domain(){return this._config.entity.split(".")[0]}_iconName(t){return this._config.icon?this._config.icon:t&&Lt[t]?Lt[t]:Ot[this._domain]??"circle"}_stateText(){const t=this.hass.states[this._config.entity];if(jt.has(this._domain))return"light"===this._domain&&"on"===t.state&&null!=t.attributes.brightness?`${Math.round(Number(t.attributes.brightness)/255*100)}%`:"on"===t.state?"On":"Off";const e=t.attributes.unit_of_measurement,i=Number(t.state),s=Number.isNaN(i)?t.state:Math.abs(i)>=100?Math.round(i):i;return e?`${s}${e.startsWith("°")?"":" "}${e}`:String(s)}_tap(){this.hass&&this._config&&(jt.has(this._domain)?this.hass.callService("homeassistant","toggle",{entity_id:this._config.entity}):xt(this,"hass-more-info",{entityId:this._config.entity}))}_toggleClick(t){t.stopPropagation(),this.hass.callService("homeassistant","toggle",{entity_id:this._config.entity})}render(){if(!this._config||!this.hass)return Y;const t=this._config.entity?this.hass.states[this._config.entity]:void 0;if(!t)return yt("Select an entity","add_box");const e="on"===t.state||"open"===t.state||"home"===t.state||"playing"===t.state,i=jt.has(this._domain),s=this._config.name??t.attributes.friendly_name??this._config.entity,a=t.attributes.device_class;return q`
    ...
    `],e([mt({attribute:!1})],me.prototype,"hass",void 0),e([ft()],me.prototype,"_config",void 0),me=e([pt("glass-badge-strip-card")],me);let fe=class extends dt{setConfig(t){this._config=t}getCardSize(){return 1}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entity:""}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||[this._config.entity,this._config.battery].filter(Boolean).some(t=>e.states[t]!==this.hass.states[t])}_batteryIcon(t){return t>=95?"battery_full":t>=60?"battery_5_bar":t>=40?"battery_3_bar":t>=15?"battery_2_bar":"battery_alert"}render(){if(!this._config||!this.hass)return Y;const t=this._config.entity?this.hass.states[this._config.entity]:void 0;if(!t)return yt("Select a person entity","person");const e="home"===t.state,i=e?"Home":"not_home"===t.state?"Away":t.state.charAt(0).toUpperCase()+t.state.slice(1),s=e?"var(--g-green)":"not_home"===t.state?"var(--g-dim)":"var(--g-amber)",a=this._config.name??t.attributes.friendly_name??this._config.entity,r=t.attributes.entity_picture,n=a.charAt(0).toUpperCase(),o=e?"home":"not_home"===t.state?"directions_walk":"location_on",l=this._config.battery?Number(this.hass.states[this._config.battery]?.state):NaN,c=!Number.isNaN(l);return q`
      <button class="card" @click=${()=>xt(this,"hass-more-info",{entityId:this._config.entity})}>
        ...
        <div class="right">
          ${c?q`<div class="batt">${_t(this._batteryIcon(l),16,"var(--g-text)")}${Math.round(l)}</div>`:Y}
    ...
    `],e([mt({attribute:!1})],fe.prototype,"hass",void 0),e([ft()],fe.prototype,"_config",void 0),fe=e([pt("glass-person-badge-card")],fe);const ve={"clear-night":{icon:"bedtime",label:"Clear night"},cloudy:{icon:"cloud",label:"Cloudy"},fog:{icon:"foggy",label:"Fog"},hail:{icon:"weather_hail",label:"Hail"},lightning:{icon:"thunderstorm",label:"Lightning"},"lightning-rainy":{icon:"thunderstorm",label:"Storms"},partlycloudy:{icon:"partly_cloudy_day",label:"Partly cloudy"},pouring:{icon:"rainy",label:"Heavy rain"},rainy:{icon:"rainy",label:"Rain"},snowy:{icon:"weather_snowy",label:"Snow"},"snowy-rainy":{icon:"weather_mix",label:"Sleet"},sunny:{icon:"clear_day",label:"Sunny"},windy:{icon:"air",label:"Windy"},"windy-variant":{icon:"air",label:"Windy"},exceptional:{icon:"warning",label:"Severe"}},be=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],xe=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];let _e=class extends dt{constructor(){super(...arguments),this._now=new Date,this._open=()=>{this._config?.weather&&xt(this,"hass-more-info",{entityId:this._config.weather})}}setConfig(t){this._config=t}getCardSize(){return"compact"===this._config?.layout?2:3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{weather:"",layout:"full",show_seconds:!0,show_forecast:!0,forecast_days:4}}connectedCallback(){super.connectedCallback(),this._timer=window.setInterval(()=>this._now=new Date,1e3)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&window.clearInterval(this._timer)}_greeting(t){return t<12?"Good morning":t<18?"Good afternoon":"Good evening"}_forecast(){const t=this._config?.weather?this.hass?.states[this._config.weather]:void 0,e=t?.attributes.forecast;if(!Array.isArray(e))return[];const i=this._config?.forecast_days??4;return e.slice(0,i)}render(){if(!this._config||!this.hass)return Y;const t="compact"===this._config.layout,e=this._now,i=`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`,s=String(e.getSeconds()).padStart(2,"0"),a=`${be[e.getDay()]}, ${e.getDate()} ${xe[e.getMonth()]}`,r=this._greeting(e.getHours()),n=this._config.weather?this.hass.states[this._config.weather]:void 0;if(this._config.weather&&!n)return yt("Select a weather entity","schedule");let o,l="",c="";if(n){o=ve[n.state]??{icon:"thermostat",label:n.state};const t=n.attributes;c=t.temperature_unit||`°${this.hass.config.unit_system.temperature.replace("°","")}`,l=null!=t.temperature?String(Math.round(Number(t.temperature))):"—"}if(t)return q`
      ...
      `;const d=!1!==this._config.show_forecast?this._forecast():[];return q`
      <div class="card full" @click=${this._open}>
        <div class="clock">
          <div class="greeting">${r}</div>
          <div class="hhmm-row">
            <span class="hhmm">${i}</span>
            ${!1!==this._config.show_seconds?q`<span class="secs">${s}</span>`:Y}
          </div>
        ...
        ${d.length?q`<div class="fc">
              ${d.map(t=>{const e=new Date(t.datetime),i=be[e.getDay()].slice(0,3),s=t.condition?ve[t.condition]:void 0;return q`<div class="fc-day">
    ...
    `],e([mt({attribute:!1})],_e.prototype,"hass",void 0),e([ft()],_e.prototype,"_config",void 0),e([ft()],_e.prototype,"_now",void 0),_e=e([pt("glass-clock-weather-card")],_e);const ye={amber:"var(--g-amber)",cyan:"var(--g-cyan)",purple:"var(--g-purple)",green:"var(--g-green)",red:"var(--g-red-text)"};let we=class extends dt{constructor(){super(...arguments),this._toggle=t=>{t.stopPropagation();const e=this._config?.lights??[];if(!e.length||!this.hass)return;const i=this._lightsOn().length>0;this.hass.callService("light",i?"turn_off":"turn_on",{entity_id:e})}}setConfig(t){this._config={name:"Room",...t}}getCardSize(){return 2}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{name:"Living Room",icon:"weekend",color:"amber",lights:[]}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");if(!e||!this.hass||!this._config)return!0;const i=this._config;return[...i.lights??[],i.temp,i.humidity,i.devices].filter(Boolean).some(t=>e.states[t]!==this.hass.states[t])}_num(t){if(!t)return"—";const e=this.hass?.states[t];if(!e)return"—";const i=Number(e.state);return Number.isNaN(i)?"—":String(Math.round(10*i)/10)}_lightsOn(){return(this._config?.lights??[]).filter(t=>"on"===this.hass?.states[t]?.state)}render(){if(!this._config||!this.hass)return Y;if(!this._config.name&&!this._config.lights?.length&&!this._config.temp)return yt("Configure this room","meeting_room");const t=ye[this._config.color??"amber"]??"var(--g-amber)",e=this._config.lights??[],i=this._lightsOn().length,s=i>0,a=e.length?s?`${i} of ${e.length} lights on`:"All off":"No lights";let r="—";if(this._config.devices){const t=this._num(this._config.devices);r="—"!==t?t:String(this.hass.states[this._config.devices]?1:0)}else e.length&&(r=String(e.length));return q`
      <div class="card ${s?"on":""}" style="--accent:${t}">
        <div class="head">
          ...
          ${e.length?q`<div class="track ${s?"on":""}" @click=${this._toggle} role="switch" aria-checked=${s}>
                <div class="knob"></div>
              </div>`:Y}
        </div>
    ...
    `],e([mt({attribute:!1})],ke.prototype,"hass",void 0),e([ft()],ke.prototype,"_config",void 0),ke=e([pt("glass-people-row-card")],ke);const Se={amber:"var(--g-amber)",cyan:"var(--g-cyan)",purple:"var(--g-purple)",green:"var(--g-green)",red:"var(--g-red-text)",orange:"#ff8c42"};let Ce=class extends dt{setConfig(t){this._config=t}getCardSize(){return 1}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entity:""}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||e.states[this._config.entity]!==this.hass.states[this._config.entity]}_temp(){const t=this.hass.states[this._config.entity];if(!t)return"—";const e=t.attributes.current_temperature,i=Number(null!=e?e:t.state);return Number.isNaN(i)?"—":String(Math.round(10*i)/10)}_defaultIcon(t){return"water_heater"===t?"water_heater":"climate"===t?"mode_fan":"device_thermostat"}render(){if(!this._config||!this.hass)return Y;if(!this._config.entity)return yt("Select a climate entity","device_thermostat");const t=this.hass.states[this._config.entity];if(!t)return yt("Entity not found","device_thermostat");const e=this._config.entity.split(".")[0],i=Se[this._config.color??("water_heater"===e?"orange":"cyan")]??"var(--g-cyan)",s=this._config.icon??this._defaultIcon(e),a=this._config.name??t.attributes.friendly_name??this._config.entity;return q`
      <div class="card" @click=${()=>xt(this,"hass-more-info",{entityId:this._config.entity})}>
        ${_t(s,22,i)}
        <div class="txt">
    ...
    `],e([mt({attribute:!1})],Ce.prototype,"hass",void 0),e([ft()],Ce.prototype,"_config",void 0),Ce=e([pt("glass-climate-tile-card")],Ce);const ze=(t,e=!1)=>({entity:{...t?{domain:t}:{},...e?{multiple:!0}:{}}}),Ae={text:{}},Ee=(t,e)=>({number:{min:t,max:e,mode:"box"}}),Ne=t=>({select:{mode:"dropdown",options:t}}),Me={boolean:{}},Pe={"glass-person-card":[{name:"title",selector:Ae},{name:"entities",required:!0,selector:ze("person",!0)}],"glass-weather-card":[{name:"entity",required:!0,selector:ze("weather")},{name:"sun",selector:ze("sun")},{name:"humidity",selector:ze("sensor")}],"glass-camera-card":[{name:"entity",required:!0,selector:ze("camera")},{name:"name",selector:Ae},{name:"icon",selector:Ae},{name:"show_timestamp",selector:Me}],"glass-alarm-card":[{name:"entity",required:!0,selector:ze("alarm_control_panel")},{name:"variant",selector:Ne([{value:"shield",label:"Shield (default)"},{value:"radial",label:"Radial"},{value:"bar",label:"Compact bar"},{value:"keypad",label:"Keypad"},{value:"triggered",label:"Triggered / status"}])},{name:"name",selector:Ae},{name:"subtitle",selector:Ae},{name:"code",selector:Ae},{name:"code_length",selector:Ee(1,8)},{name:"buttons",selector:{select:{multiple:!0,mode:"list",options:[{value:"disarm",label:"Disarm"},{value:"arm",label:"Arm (single button)"},{value:"arm_home",label:"Arm Home"},{value:"arm_away",label:"Arm Away"},{value:"arm_night",label:"Arm Night"},{value:"arm_vacation",label:"Arm Vacation"}]}}}],"glass-media-card":[{name:"entity",required:!0,selector:ze("media_player")},{name:"name",selector:Ae}],"glass-flight-card":[{name:"entity",required:!0,selector:ze("sensor")},{name:"title",selector:Ae},{name:"max",selector:Ee(1,10)}],"glass-tile-card":[{name:"entity",required:!0,selector:ze()},{name:"name",selector:Ae},{name:"icon",selector:Ae}],"glass-energy-card":[{name:"title",selector:Ae},{name:"variant",selector:Ne([{value:"flow",label:"Power flow (default)"},{value:"ring",label:"Battery ring"},{value:"stats",label:"Stat trio"},{value:"meters",label:"Meters"},{value:"production",label:"Production bars"},{value:"strip",label:"Compact solar strip (mobile)"},{value:"bar",label:"Compact energy mix bar (mobile)"}])},{name:"solar",selector:ze("sensor")},{name:"grid",selector:ze("sensor")},{name:"battery",selector:ze("sensor")},{name:"battery_soc",selector:ze("sensor")},{name:"house",selector:ze("sensor")},{name:"today",selector:ze("sensor")},{name:"imported",selector:ze("sensor")},{name:"exported",selector:ze("sensor")},{name:"saved",selector:ze("sensor")},{name:"meters",selector:ze("sensor",!0)},{name:"production",selector:ze("sensor")}],"glass-sensor-list-card":[{name:"title",selector:Ae},{name:"entities",required:!0,selector:ze(["cover","binary_sensor"],!0)}],"glass-appliance-card":[{name:"name",selector:Ae},{name:"subtitle",selector:Ae},{name:"icon",selector:Ae},{name:"icon_color",selector:{select:{mode:"dropdown",options:["cyan","amber","green","purple","red"]}}},{name:"status",selector:ze(["sensor","binary_sensor"])},{name:"remaining",selector:ze("sensor")},{name:"total",selector:ze("sensor")},{name:"toggle",selector:ze(["switch","input_boolean"])},{name:"stats",selector:ze(["sensor","binary_sensor","number"],!0)}],"glass-fridge-card":[{name:"name",selector:Ae},{name:"subtitle",selector:Ae},{name:"door",selector:ze("binary_sensor")},{name:"wifi",selector:ze("binary_sensor")},{name:"fridge_temp",selector:ze("number")},{name:"freezer_temp",selector:ze("number")},{name:"toggles",selector:ze(["switch","input_boolean"],!0)}],"glass-pool-card":[{name:"name",selector:Ae},{name:"subtitle",selector:Ae},{name:"switch",selector:ze(["switch","input_boolean"])},{name:"energy",selector:ze("sensor")},{name:"color",selector:Ne(["green","amber","cyan","purple","red"])}],"glass-stat-card":[{name:"entity",required:!0,selector:ze()},{name:"name",selector:Ae},{name:"icon",selector:Ae},{name:"color",selector:Ne(["amber","green","cyan","purple","red","dim"])}],"glass-lights-card":[{name:"title",selector:Ae},{name:"entities",required:!0,selector:ze("light",!0)}],"glass-scenes-card":[{name:"title",selector:Ae},{name:"columns",selector:Ee(2,6)},{name:"scenes",required:!0,selector:ze(["scene","script","automation"],!0)}],"glass-toggle-grid-card":[{name:"title",selector:Ae},{name:"columns",selector:Ee(2,8)},{name:"entities",required:!0,selector:ze(["light","switch","fan","input_boolean","script","scene"],!0)}],"glass-heatpump-card":[{name:"entity",required:!0,selector:ze("climate")},{name:"name",selector:Ae},{name:"subtitle",selector:Ae}],"glass-garage-card":[{name:"entity",selector:ze("cover")},{name:"state_entity",selector:ze(["binary_sensor","cover"])},{name:"trigger",selector:ze(["switch","button","script","input_boolean"])},{name:"variant",selector:Ne([{value:"full",label:"Full (animated visual)"},{value:"compact",label:"Compact tile"}])},{name:"name",selector:Ae},{name:"subtitle",selector:Ae}],"glass-badge-strip-card":[{name:"variant",selector:Ne([{value:"strip",label:"Strip"},{value:"circular",label:"Circular"}])},{name:"badges",required:!0,selector:ze(void 0,!0)}],"glass-person-badge-card":[{name:"entity",required:!0,selector:ze(["person","device_tracker"])},{name:"name",selector:Ae},{name:"battery",selector:ze("sensor")}],"glass-sprinkler-card":[{name:"entity",required:!0,selector:ze(["switch","valve","input_boolean"])},{name:"variant",selector:Ne([{value:"hero",label:"Hero (animated)"},{value:"compact",label:"Compact tile"}])},{name:"name",selector:Ae},{name:"subtitle",selector:Ae}],"glass-irrigation-card":[{name:"title",selector:Ae},{name:"zones",required:!0,selector:ze(["switch","valve","input_boolean"],!0)}],"glass-water-chemistry-card":[{name:"title",selector:Ae},{name:"metrics",selector:ze("sensor",!0)}],"glass-nav-card":[{name:"variant",selector:Ne([{value:"dock",label:"Full-width dock"},{value:"pill",label:"Floating pill"}])},{name:"fixed",selector:Me},{name:"max_width",selector:Ee(320,1600)}],"glass-light-card":[{name:"entity",required:!0,selector:ze("light")},{name:"name",selector:Ae},{name:"subtitle",selector:Ae}],"glass-aircon-card":[{name:"entity",required:!0,selector:ze("climate")},{name:"name",selector:Ae},{name:"subtitle",selector:Ae}],"glass-geyser-card":[{name:"name",selector:Ae},{name:"subtitle",selector:Ae},{name:"power",selector:ze(["switch","input_boolean","water_heater"])},{name:"current",selector:ze("sensor")},{name:"target",selector:ze(["number","water_heater","climate"])},{name:"min_temp",selector:Ee(0,100)},{name:"max_temp",selector:Ee(0,100)},{name:"solar",selector:ze("sensor")},{name:"power_sensor",selector:ze("sensor")},{name:"solar_mode",selector:ze(["switch","input_boolean"])},{name:"modes",selector:ze(["switch","input_boolean"],!0)}],"glass-clock-weather-card":[{name:"weather",selector:ze("weather")},{name:"layout",selector:Ne([{value:"full",label:"Full (desktop hero)"},{value:"compact",label:"Compact (mobile strip)"}])},{name:"show_seconds",selector:Me},{name:"show_forecast",selector:Me},{name:"forecast_days",selector:Ee(1,7)}],"glass-room-card":[{name:"name",required:!0,selector:Ae},{name:"icon",selector:Ae},{name:"color",selector:Ne(["amber","cyan","purple","green","red"])},{name:"lights",selector:ze("light",!0)},{name:"temp",selector:ze("sensor")},{name:"humidity",selector:ze("sensor")},{name:"devices",selector:ze("sensor")}],"glass-people-row-card":[{name:"entities",required:!0,selector:ze(["person","device_tracker"],!0)}],"glass-climate-tile-card":[{name:"entity",required:!0,selector:ze(["climate","water_heater","sensor"])},{name:"name",selector:Ae},{name:"icon",selector:Ae},{name:"color",selector:Ne(["cyan","amber","orange","purple","green","red"])}],"glass-dishwasher-card":[{name:"name",selector:Ae},{name:"subtitle",selector:Ae},{name:"status",selector:ze("sensor")},{name:"alert",selector:ze("binary_sensor")},{name:"alert_text",selector:Ae},{name:"tiles",selector:ze(["binary_sensor","sensor"],!0)},{name:"levels",selector:ze("sensor",!0)},{name:"level_max",selector:Ee(1,10)}]},je={entity:"Entity",entities:"Entities",title:"Title",name:"Name (optional)",icon:"Icon (optional)",sun:"Sun entity (for sunrise/sunset)",humidity:"Humidity sensor (optional)",code:"Arm/disarm code (optional)",max:"Max flights to show",buttons:"Action buttons to show",variant:"Layout / style",code_length:"Keypad code length",today:"Solar-today energy sensor (big number)",imported:"Imported-today sensor",exported:"Exported-today sensor",saved:"Money-saved sensor",meters:"Percentage sensors to show as meters",production:"Production sensor for hourly bars (needs statistics)",subtitle:"Subtitle (e.g. room/area)",icon_color:"Icon accent colour",status:"Status sensor (drives the pill)",remaining:"Remaining-time sensor (timestamp → progress ring)",total:"Total-time sensor (minutes, for the ring %)",toggle:"Power switch (optional on/off button)",stats:"Extra sensors shown as stat tiles",door:"Door sensor",wifi:"Wi-Fi / connectivity sensor (optional)",fridge_temp:"Fridge temperature (number entity)",freezer_temp:"Freezer temperature (number entity)",toggles:"Feature switches (Express cool/mode, etc.)",switch:"Pump switch",energy:"Energy sensor (kWh)",color:"Accent colour",columns:"Columns",scenes:"Scenes / scripts to show",alert:"Alert sensor (e.g. refill needed)",alert_text:"Alert message",tiles:"Status tiles",levels:"Level sensors (shown as bars)",level_max:"Level bar maximum",power:"Power switch (on/off)",current:"Current temperature sensor",target:"Target temperature (number / thermostat)",min_temp:"Minimum temperature",max_temp:"Maximum temperature",solar:"Solar collector temperature sensor",power_sensor:"Power draw sensor (kW)",solar_mode:"Solar mode switch (toggleable)",modes:"Extra mode switches (boost, element, timer)",metrics:"Water metric sensors (pH, chlorine, …)",fixed:"Stick to bottom of screen",max_width:"Maximum width (px)",show_timestamp:"Show date/time overlay",state_entity:"State sensor (open / closed)",trigger:"Trigger to open/close (switch / button / script)",badges:"Status badges",battery:"Battery sensor (optional)",solar:"Solar power sensor",grid:"Grid power sensor (+import / −export)",battery:"Battery power sensor (+discharge / −charge)",battery_soc:"Battery charge % sensor",house:"House load sensor (optional; derived if empty)",weather:"Weather entity (optional — omit for clock only)",layout:"Layout",show_seconds:"Show seconds",show_forecast:"Show forecast",forecast_days:"Forecast days",lights:"Room lights (master toggle)",temp:"Temperature sensor",devices:"Device-count sensor (optional)"},Oe={icon:"Material Symbols name, e.g. lightbulb, garage, kitchen",code:"Only if your panel requires a code to arm/disarm"};let Le=class extends dt{constructor(){super(...arguments),this._label=t=>je[t.name]??t.name,this._helper=t=>Oe[t.name]??""}setConfig(t){this._config=t}_valueChanged(t){if(t.stopPropagation(),!this._config)return;const e={...this._config,...t.detail.value,type:this._config.type};xt(this,"config-changed",{config:e})}render(){if(!this.hass||!this._config)return Y;const t=this._config.type.replace(/^custom:/,""),e=Pe[t];return e?q`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${e}
      ...
      ></ha-form>
    `:q`<div class="fallback">No visual editor for <code>${this._config.type}</code> — edit in YAML.</div>`}};Le.styles=o`
    .fallback { padding: 12px; color: var(--secondary-text-color, #8b9099); font-size: 14px; }
    code { font-family: monospace; }
  `,e([mt({attribute:!1})],Le.prototype,"hass",void 0),e([ft()],Le.prototype,"_config",void 0),Le=e([pt("glass-config-editor")],Le);const Ue=["light","switch","fan","input_boolean","script","scene","automation","cover"],Te=[{name:"title",selector:{text:{}}},{name:"columns",selector:{number:{min:1,max:12,mode:"box"}}}];let He=class extends dt{constructor(){super(...arguments),this._headLabel=t=>"columns"===t.name?"Columns":"Title"}setConfig(t){this._config=t}get _items(){return(this._config?.entities??[]).map(t=>"string"==typeof t?{entity:t}:{...t})}_emit(t){xt(this,"config-changed",{config:{...this._config,...t}})}_headChanged(t){t.stopPropagation(),this._emit(t.detail.value)}_setItems(t){const e=t.map(t=>{const e={entity:t.entity};return t.name&&(e.name=t.name),t.icon&&(e.icon=t.icon),e});this._emit({entities:e})}_update(t,e){const i=this._items;i[t]={...i[t],...e},this._setItems(i)}_remove(t){const e=this._items;e.splice(t,1),this._setItems(e)}_add(){this._setItems([...this._items,{entity:""}])}render(){if(!this.hass||!this._config)return Y;const t=this._items;return q`
      <div class="wrap">
        <ha-form
          .hass=${this.hass}
