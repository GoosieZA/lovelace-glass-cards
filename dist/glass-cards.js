...
`;let wt=class extends dt{setConfig(t){this._config={title:"Home",entities:[],...t}}getCardSize(){return 2}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{title:"Home",entities:[]}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||this._config.entities.some(t=>e.states[t]!==this.hass.states[t])}_statusOf(t){const e=this.hass?.states[t];if(!e)return{label:"Unknown",home:!1,accent:"var(--g-dim)"};if("home"===e.state)return{label:"Home",home:!0,accent:"var(--g-green)"};if("not_home"===e.state)return{label:"Away",home:!1,accent:"var(--g-dim)"};return{label:e.state.charAt(0).toUpperCase()+e.state.slice(1),home:!1,accent:"var(--g-amber)"}}_relTime(t){if(!t)return"";const e=Math.round((Date.now()-new Date(t).getTime())/6e4);if(e<1)return"just now";if(e<60)return`${e}m ago`;const i=Math.round(e/60);return i<24?`${i}h ago`:`${Math.round(i/24)}d ago`}_open(t){xt(this,"hass-more-info",{entityId:t})}render(){if(!this._config||!this.hass)return Y;if(!this._config.entities.length)return yt("Add person entities","group");const t=this._config.entities.map(t=>({id:t,st:this.hass.states[t]})),e=t.filter(t=>"home"===t.st?.state).length;return q`
    ...
    `],e([mt({attribute:!1})],fe.prototype,"hass",void 0),e([ft()],fe.prototype,"_config",void 0),fe=e([pt("glass-person-badge-card")],fe);const ve=(t,e=!1)=>({entity:{...t?{domain:t}:{},...e?{multiple:!0}:{}}}),be={text:{}},xe=(t,e)=>({number:{min:t,max:e,mode:"box"}}),_e=t=>({select:{mode:"dropdown",options:t}}),ye={boolean:{}},$e={"glass-person-card":[{name:"title",selector:be},{name:"entities",required:!0,selector:ve("person",!0)}],"glass-weather-card":[{name:"entity",required:!0,selector:ve("weather")},{name:"sun",selector:ve("sun")},{name:"humidity",selector:ve("sensor")}],"glass-camera-card":[{name:"entity",required:!0,selector:ve("camera")},{name:"name",selector:be},{name:"icon",selector:be},{name:"show_timestamp",selector:ye}],"glass-alarm-card":[{name:"entity",required:!0,selector:ve("alarm_control_panel")},{name:"variant",selector:_e([{value:"shield",label:"Shield (default)"},{value:"radial",label:"Radial"},{value:"bar",label:"Compact bar"},{value:"keypad",label:"Keypad"},{value:"triggered",label:"Triggered / status"}])},{name:"name",selector:be},{name:"subtitle",selector:be},{name:"code",selector:be},{name:"code_length",selector:xe(1,8)},{name:"buttons",selector:{select:{multiple:!0,mode:"list",options:[{value:"disarm",label:"Disarm"},{value:"arm",label:"Arm (single button)"},{value:"arm_home",label:"Arm Home"},{value:"arm_away",label:"Arm Away"},{value:"arm_night",label:"Arm Night"},{value:"arm_vacation",label:"Arm Vacation"}]}}}],"glass-media-card":[{name:"entity",required:!0,selector:ve("media_player")},{name:"name",selector:be}],"glass-flight-card":[{name:"entity",required:!0,selector:ve("sensor")},{name:"title",selector:be},{name:"max",selector:xe(1,10)}],"glass-tile-card":[{name:"entity",required:!0,selector:ve()},{name:"name",selector:be},{name:"icon",selector:be}],"glass-energy-card":[{name:"title",selector:be},{name:"variant",selector:_e([{value:"flow",label:"Power flow (default)"},{value:"ring",label:"Battery ring"},{value:"stats",label:"Stat trio"},{value:"meters",label:"Meters"},{value:"production",label:"Production bars"}])},{name:"solar",selector:ve("sensor")},{name:"grid",selector:ve("sensor")},{name:"battery",selector:ve("sensor")},{name:"battery_soc",selector:ve("sensor")},{name:"house",selector:ve("sensor")},{name:"today",selector:ve("sensor")},{name:"imported",selector:ve("sensor")},{name:"exported",selector:ve("sensor")},{name:"saved",selector:ve("sensor")},{name:"meters",selector:ve("sensor",!0)},{name:"production",selector:ve("sensor")}],"glass-sensor-list-card":[{name:"title",selector:be},{name:"entities",required:!0,selector:ve(["cover","binary_sensor"],!0)}],"glass-appliance-card":[{name:"name",selector:be},{name:"subtitle",selector:be},{name:"icon",selector:be},{name:"icon_color",selector:{select:{mode:"dropdown",options:["cyan","amber","green","purple","red"]}}},{name:"status",selector:ve(["sensor","binary_sensor"])},{name:"remaining",selector:ve("sensor")},{name:"total",selector:ve("sensor")},{name:"toggle",selector:ve(["switch","input_boolean"])},{name:"stats",selector:ve(["sensor","binary_sensor","number"],!0)}],"glass-fridge-card":[{name:"name",selector:be},{name:"subtitle",selector:be},{name:"door",selector:ve("binary_sensor")},{name:"wifi",selector:ve("binary_sensor")},{name:"fridge_temp",selector:ve("number")},{name:"freezer_temp",selector:ve("number")},{name:"toggles",selector:ve(["switch","input_boolean"],!0)}],"glass-pool-card":[{name:"name",selector:be},{name:"subtitle",selector:be},{name:"switch",selector:ve(["switch","input_boolean"])},{name:"energy",selector:ve("sensor")},{name:"color",selector:_e(["green","amber","cyan","purple","red"])}],"glass-stat-card":[{name:"entity",required:!0,selector:ve()},{name:"name",selector:be},{name:"icon",selector:be},{name:"color",selector:_e(["amber","green","cyan","purple","red","dim"])}],"glass-lights-card":[{name:"title",selector:be},{name:"entities",required:!0,selector:ve("light",!0)}],"glass-scenes-card":[{name:"title",selector:be},{name:"columns",selector:xe(2,6)},{name:"scenes",required:!0,selector:ve(["scene","script","automation"],!0)}],"glass-toggle-grid-card":[{name:"title",selector:be},{name:"columns",selector:xe(2,8)},{name:"entities",required:!0,selector:ve(["light","switch","fan","input_boolean","script","scene"],!0)}],"glass-heatpump-card":[{name:"entity",required:!0,selector:ve("climate")},{name:"name",selector:be},{name:"subtitle",selector:be}],"glass-garage-card":[{name:"entity",selector:ve("cover")},{name:"state_entity",selector:ve(["binary_sensor","cover"])},{name:"trigger",selector:ve(["switch","button","script","input_boolean"])},{name:"variant",selector:_e([{value:"full",label:"Full (animated visual)"},{value:"compact",label:"Compact tile"}])},{name:"name",selector:be},{name:"subtitle",selector:be}],"glass-badge-strip-card":[{name:"variant",selector:_e([{value:"strip",label:"Strip"},{value:"circular",label:"Circular"}])},{name:"badges",required:!0,selector:ve(void 0,!0)}],"glass-person-badge-card":[{name:"entity",required:!0,selector:ve(["person","device_tracker"])},{name:"name",selector:be},{name:"battery",selector:ve("sensor")}],"glass-sprinkler-card":[{name:"entity",required:!0,selector:ve(["switch","valve","input_boolean"])},{name:"variant",selector:_e([{value:"hero",label:"Hero (animated)"},{value:"compact",label:"Compact tile"}])},{name:"name",selector:be},{name:"subtitle",selector:be}],"glass-irrigation-card":[{name:"title",selector:be},{name:"zones",required:!0,selector:ve(["switch","valve","input_boolean"],!0)}],"glass-water-chemistry-card":[{name:"title",selector:be},{name:"metrics",selector:ve("sensor",!0)}],"glass-nav-card":[{name:"variant",selector:_e([{value:"dock",label:"Full-width dock"},{value:"pill",label:"Floating pill"}])},{name:"fixed",selector:ye},{name:"max_width",selector:xe(320,1600)}],"glass-light-card":[{name:"entity",required:!0,selector:ve("light")},{name:"name",selector:be},{name:"subtitle",selector:be}],"glass-aircon-card":[{name:"entity",required:!0,selector:ve("climate")},{name:"name",selector:be},{name:"subtitle",selector:be}],"glass-geyser-card":[{name:"name",selector:be},{name:"subtitle",selector:be},{name:"power",selector:ve(["switch","input_boolean","water_heater"])},{name:"current",selector:ve("sensor")},{name:"target",selector:ve(["number","water_heater","climate"])},{name:"min_temp",selector:xe(0,100)},{name:"max_temp",selector:xe(0,100)},{name:"solar",selector:ve("sensor")},{name:"power_sensor",selector:ve("sensor")},{name:"solar_mode",selector:ve(["switch","input_boolean"])},{name:"modes",selector:ve(["switch","input_boolean"],!0)}],"glass-dishwasher-card":[{name:"name",selector:be},{name:"subtitle",selector:be},{name:"status",selector:ve("sensor")},{name:"alert",selector:ve("binary_sensor")},{name:"alert_text",selector:be},{name:"tiles",selector:ve(["binary_sensor","sensor"],!0)},{name:"levels",selector:ve("sensor",!0)},{name:"level_max",selector:xe(1,10)}]},we={entity:"Entity",entities:"Entities",title:"Title",name:"Name (optional)",icon:"Icon (optional)",sun:"Sun entity (for sunrise/sunset)",humidity:"Humidity sensor (optional)",code:"Arm/disarm code (optional)",max:"Max flights to show",buttons:"Action buttons to show",variant:"Layout / style",code_length:"Keypad code length",today:"Solar-today energy sensor (big number)",imported:"Imported-today sensor",exported:"Exported-today sensor",saved:"Money-saved sensor",meters:"Percentage sensors to show as meters",production:"Production sensor for hourly bars (needs statistics)",subtitle:"Subtitle (e.g. room/area)",icon_color:"Icon accent colour",status:"Status sensor (drives the pill)",remaining:"Remaining-time sensor (timestamp → progress ring)",total:"Total-time sensor (minutes, for the ring %)",toggle:"Power switch (optional on/off button)",stats:"Extra sensors shown as stat tiles",door:"Door sensor",wifi:"Wi-Fi / connectivity sensor (optional)",fridge_temp:"Fridge temperature (number entity)",freezer_temp:"Freezer temperature (number entity)",toggles:"Feature switches (Express cool/mode, etc.)",switch:"Pump switch",energy:"Energy sensor (kWh)",color:"Accent colour",columns:"Columns",scenes:"Scenes / scripts to show",alert:"Alert sensor (e.g. refill needed)",alert_text:"Alert message",tiles:"Status tiles",levels:"Level sensors (shown as bars)",level_max:"Level bar maximum",power:"Power switch (on/off)",current:"Current temperature sensor",target:"Target temperature (number / thermostat)",min_temp:"Minimum temperature",max_temp:"Maximum temperature",solar:"Solar collector temperature sensor",power_sensor:"Power draw sensor (kW)",solar_mode:"Solar mode switch (toggleable)",modes:"Extra mode switches (boost, element, timer)",metrics:"Water metric sensors (pH, chlorine, …)",fixed:"Stick to bottom of screen",max_width:"Maximum width (px)",show_timestamp:"Show date/time overlay",state_entity:"State sensor (open / closed)",trigger:"Trigger to open/close (switch / button / script)",badges:"Status badges",battery:"Battery sensor (optional)",solar:"Solar power sensor",grid:"Grid power sensor (+import / −export)",battery:"Battery power sensor (+discharge / −charge)",battery_soc:"Battery charge % sensor",house:"House load sensor (optional; derived if empty)"},ke={icon:"Material Symbols name, e.g. lightbulb, garage, kitchen",code:"Only if your panel requires a code to arm/disarm"};let Se=class extends dt{constructor(){super(...arguments),this._label=t=>we[t.name]??t.name,this._helper=t=>ke[t.name]??""}setConfig(t){this._config=t}_valueChanged(t){if(t.stopPropagation(),!this._config)return;const e={...this._config,...t.detail.value,type:this._config.type};xt(this,"config-changed",{config:e})}render(){if(!this.hass||!this._config)return Y;const t=this._config.type.replace(/^custom:/,""),e=$e[t];return e?q`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${e}
      ...
      ></ha-form>
    `:q`<div class="fallback">No visual editor for <code>${this._config.type}</code> — edit in YAML.</div>`}};Se.styles=o`
    .fallback { padding: 12px; color: var(--secondary-text-color, #8b9099); font-size: 14px; }
    code { font-family: monospace; }
  `,e([mt({attribute:!1})],Se.prototype,"hass",void 0),e([ft()],Se.prototype,"_config",void 0),Se=e([pt("glass-config-editor")],Se);const Ce=["light","switch","fan","input_boolean","script","scene","automation","cover"],ze=[{name:"title",selector:{text:{}}},{name:"columns",selector:{number:{min:1,max:12,mode:"box"}}}];let Ae=class extends dt{constructor(){super(...arguments),this._headLabel=t=>"columns"===t.name?"Columns":"Title"}setConfig(t){this._config=t}get _items(){return(this._config?.entities??[]).map(t=>"string"==typeof t?{entity:t}:{...t})}_emit(t){xt(this,"config-changed",{config:{...this._config,...t}})}_headChanged(t){t.stopPropagation(),this._emit(t.detail.value)}_setItems(t){const e=t.map(t=>{const e={entity:t.entity};return t.name&&(e.name=t.name),t.icon&&(e.icon=t.icon),e});this._emit({entities:e})}_update(t,e){const i=this._items;i[t]={...i[t],...e},this._setItems(i)}_remove(t){const e=this._items;e.splice(t,1),this._setItems(e)}_add(){this._setItems([...this._items,{entity:""}])}render(){if(!this.hass||!this._config)return Y;const t=this._items;return q`
      <div class="wrap">
        <ha-form
          .hass=${this.hass}
