...
`;let wt=class extends dt{setConfig(t){this._config={title:"Home",entities:[],...t}}getCardSize(){return 2}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{title:"Home",entities:[]}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||this._config.entities.some(t=>e.states[t]!==this.hass.states[t])}_statusOf(t){const e=this.hass?.states[t];if(!e)return{label:"Unknown",home:!1,accent:"var(--g-dim)"};if("home"===e.state)return{label:"Home",home:!0,accent:"var(--g-green)"};if("not_home"===e.state)return{label:"Away",home:!1,accent:"var(--g-dim)"};return{label:e.state.charAt(0).toUpperCase()+e.state.slice(1),home:!1,accent:"var(--g-amber)"}}_relTime(t){if(!t)return"";const e=Math.round((Date.now()-new Date(t).getTime())/6e4);if(e<1)return"just now";if(e<60)return`${e}m ago`;const s=Math.round(e/60);return s<24?`${s}h ago`:`${Math.round(s/24)}d ago`}_open(t){xt(this,"hass-more-info",{entityId:t})}render(){if(!this._config||!this.hass)return Y;if(!this._config.entities.length)return yt("Add person entities","group");const t=this._config.entities.map(t=>({id:t,st:this.hass.states[t]})),e=t.filter(t=>"home"===t.st?.state).length;return q`
    ...
    `],e([mt({attribute:!1})],Ct.prototype,"hass",void 0),e([ft()],Ct.prototype,"_config",void 0),Ct=e([pt("glass-weather-card")],Ct);let zt=class extends dt{setConfig(t){this._config={icon:"videocam",...t}}getCardSize(){return 3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entity:"camera.garage",icon:"garage"}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||e.states[this._config.entity]!==this.hass.states[this._config.entity]}_stamp(t){const e=t?new Date(t):new Date,s=t=>String(t).padStart(2,"0");return`${e.getFullYear()}-${s(e.getMonth()+1)}-${s(e.getDate())} · ${s(e.getHours())}:${s(e.getMinutes())}:${s(e.getSeconds())}`}render(){if(!this._config||!this.hass)return Y;const t=this._config.entity?this.hass.states[this._config.entity]:void 0;if(!t)return yt("Select a camera entity","videocam");const e=t.attributes.entity_picture,s=this._config.name??t.attributes.friendly_name??this._config.entity,i="streaming"===t.state||"recording"===t.state||"idle"===t.state;return q`
      <div class="cam" @click=${()=>xt(this,"hass-more-info",{entityId:this._config.entity})}>
        ...
        <div class="label">${_t(this._config.icon,20,"#fff")}<span>${s}</span></div>
    ...
    `}_renderShield(){const t=this._look(this._st.state),e=this._config.name??this._st.attributes.friendly_name??"Security";return q`<div class="card" style="border-color:${t.border}">
      ...
      <button class="btn soft" @click=${()=>this._call(s?"alarm_disarm":"alarm_arm_away")}>
        ${_t(s?"lock_open":"lock",17)}${s?"Disarm":"Arm"}
      </button>
    ...
    `],e([mt({attribute:!1})],Nt.prototype,"hass",void 0),e([ft()],Nt.prototype,"_config",void 0),e([ft()],Nt.prototype,"_code",void 0),Nt=e([pt("glass-alarm-card")],Nt);const Mt=[["#7dd68a","var(--g-green)"],["#e0b24a","var(--g-amber)"],["#a97ff0","var(--g-purple)"],["#5ab9bd","var(--g-cyan)"]];let Pt=class extends dt{constructor(){super(...arguments),this._bars=[]}setConfig(t){this._config={title:"Energy",variant:"flow",...t},this._fetchedFor=void 0}getCardSize(){return"flow"===this._config?.variant||"production"===this._config?.variant?4:3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{title:"Energy",variant:"flow",solar:"sensor.solar_power",grid:"sensor.grid_power",battery:"sensor.battery_power"}}shouldUpdate(t){if(t.has("_config")||t.has("_bars"))return!0;const e=t.get("hass");if(!e||!this.hass||!this._config)return!0;const s=this._config;return[s.solar,s.grid,s.battery,s.battery_soc,s.house,s.today,s.imported,s.exported,s.saved,s.production,...s.meters??[]].filter(Boolean).some(t=>e.states[t]!==this.hass.states[t])}updated(){if(!this.hass||!this._config||"production"!==this._config.variant||!this._config.production)return;const t=this.hass.states[this._config.production];t&&t.last_updated!==this._fetchedFor&&(this._fetchedFor=t.last_updated,this._loadProduction(this._config.production))}async _loadProduction(t){const e=new Date;e.setHours(0,0,0,0);try{const s=(await this.hass.callWS({type:"recorder/statistics_during_period",start_time:e.toISOString(),statistic_ids:[t],period:"hour"}))[t]??[];this._bars=s.map(t=>({v:Math.max(0,Number(t.change??t.state??0)),label:String(new Date(Number(t.start)).getHours())}))}catch{this._bars=[]}}_watts(t){if(!t||!this.hass)return null;const e=this.hass.states[t];if(!e||"unavailable"===e.state||"unknown"===e.state)return null;const s=Number(e.state);if(Number.isNaN(s))return null;return"kw"===String(e.attributes.unit_of_measurement??"").toLowerCase()?1e3*s:s}_kw(t){return(t/1e3).toFixed(1)}_stateNum(t){const e=t?Number(this.hass.states[t]?.state):NaN;return Number.isNaN(e)?null:e}_label(t){return this.hass.states[t]?.attributes.friendly_name??t}render(){if(!this._config||!this.hass)return Y;switch(this._config.variant){case"ring":return this._renderRing();case"stats":return this._renderStats();case"meters":return this._renderMeters();case"production":return this._renderProduction();default:return this._renderFlow()}}_head(t){return q`<div class="hdr"><div class="hdr-l">${_t("bolt",22,"var(--g-amber)")}<span class="title">${this._config.title}</span></div>${t??Y}</div>`}_renderFlow(){const t=this._watts(this._config.solar),e=this._watts(this._config.grid),s=this._watts(this._config.battery);let i=this._watts(this._config.house);null==i&&(i=(t??0)+(e??0)+(s??0));const a=this._stateNum(this._config.battery_soc),r=(t??0)>20,n=(e??0)>20,o=(e??0)<-20,l=(s??0)>20,c=(s??0)<-20,d=o?{label:"Exporting",purple:!1}:n?{label:"Grid import",purple:!0}:{label:"Self-powered",purple:!1},g=(t,e,s=!1)=>t?`stroke:${e};animation:g-flow 0.7s linear infinite${s?" reverse":""};`:"stroke:rgba(255,255,255,0.06);";return q`<div class="card">
      ...
      <div class="flow">
        ...
        <div class="node home">${_t("home",26,"var(--g-amber)")}<span class="watts t-num">${Math.round(i)}</span><span class="cap">Watts now</span></div>
        ...
        ${null!=s?q`<div class="node batt"><div class="chip green">${_t(c?"battery_charging_full":"battery_full",20,"var(--g-green)")}<span style="color:var(--g-green)">${this._kw(Math.abs(s))}</span></div><span class="cap">Battery${null!=a?` · ${Math.round(a)}%`:" · kW"}</span></div>`:Y}
      </div>
    </div>`}_renderRing(){const t=this._config,e=this._stateNum(t.battery_soc)??0,s=this._watts(t.solar);let i=this._watts(t.house);null==i&&(i=(s??0)+(this._watts(t.grid)??0)+(this._watts(t.battery)??0));const a=this._watts(t.battery),r=null!=a&&Math.abs(a)>5?q`<div class="delta" style="color:${a<0?"var(--g-green)":"var(--g-amber)"}">${a<0?"↓":"↑"} ${Math.abs(Math.round(a))} W</div>`:Y;return q`<div class="card">
      ${this._head()}
      <div class="ring-row">
      ...
      ${s.length?q`<div class="tri">
            ${s.map(t=>{const e=this._fmt(t.id);return q`<div class="stat"><div class="t-num sv" style="color:${t.color}">${e.val}${e.unit?q` <span class="su">${e.unit}</span>`:Y}</div><div class="sc">${this._label(t.id)}</div></div>`})}
          </div>`:Y}
      ...
      <div class="meters">
        ${e.map((e,s)=>{const i=Math.max(0,Math.min(100,this._stateNum(e)??0)),[a,r]=Mt[s%Mt.length];return q`<div class="m">
            <div class="m-h"><span class="m-l">${_t(0===s&&t.battery_soc?"battery_charging_full":"bolt",18,r)}${this._label(e)}</span><span class="m-v">${Math.round(i)}%</span></div>
    ...
    `],e([mt({attribute:!1})],Tt.prototype,"hass",void 0),e([ft()],Tt.prototype,"_config",void 0),Tt=e([pt("glass-sensor-list-card")],Tt);let Ht=class extends dt{setConfig(t){this._config=t}getCardSize(){return 2}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entity:"media_player.kitchen"}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||e.states[this._config.entity]!==this.hass.states[this._config.entity]}_cmd(t,e){e.stopPropagation(),this.hass.callService("media_player",t,{entity_id:this._config.entity})}_progress(){const t=this.hass.states[this._config.entity],e=Number(t.attributes.media_duration);let s=Number(t.attributes.media_position);return!e||Number.isNaN(e)||Number.isNaN(s)?0:("playing"===t.state&&t.attributes.media_position_updated_at&&(s+=(Date.now()-new Date(t.attributes.media_position_updated_at).getTime())/1e3),Math.max(0,Math.min(100,s/e*100)))}render(){if(!this._config||!this.hass)return Y;const t=this._config.entity?this.hass.states[this._config.entity]:void 0;if(!t)return yt("Select a media player","speaker");const e="off"===t.state||"unavailable"===t.state||"standby"===t.state,s="playing"===t.state,i=t.attributes,a=i.entity_picture,r=i.media_title||(this._config.name??i.friendly_name??"Media"),n=[i.media_artist,i.media_album_name].filter(Boolean).join(" · ")||(e?String(t.state):i.friendly_name??"");return q`
      <div class="card" @click=${()=>xt(this,"hass-more-info",{entityId:this._config.entity})}>
        ...
        <div class="ctl">
          ...
          <button class="ico play" @click=${t=>this._cmd("media_play_pause",t)}>${_t(s?"pause":"play_arrow",24,"var(--g-amber-ink)")}</button>
    ...
    `],e([mt({attribute:!1})],Ht.prototype,"hass",void 0),e([ft()],Ht.prototype,"_config",void 0),Ht=e([pt("glass-media-card")],Ht);let Wt=class extends dt{setConfig(t){this._config={title:"Overhead",max:4,...t}}getCardSize(){return 2}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entity:"sensor.flightradar24_current_in_area",title:"Overhead"}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||e.states[this._config.entity]!==this.hass.states[this._config.entity]}_route(t){const e=t.airport_origin_code_iata||t.airport_origin_city,s=t.airport_destination_code_iata||t.airport_destination_city;return e&&s?`${e} → ${s}`:e||s||""}render(){if(!this._config||!this.hass)return Y;const t=this._config.entity?this.hass.states[this._config.entity]:void 0;if(!t)return yt("Select a Flightradar24 sensor","flight");const e=t.attributes.flights??[],s=e.length;return q`
      <div class="card" @click=${()=>xt(this,"hass-more-info",{entityId:this._config.entity})}>
        ...
        ${0===s?q`<div class="empty">${_t("travel_explore",30,"var(--g-faint)")}<span>No aircraft in your area</span></div>`:e.slice(0,this._config.max).map(t=>{const e=t.callsign||t.flight_number||"Unknown",s=[null!=t.altitude?`${Math.round(Number(t.altitude)).toLocaleString()} ft`:null,null!=t.ground_speed?`${Math.round(Number(t.ground_speed))} kt`:null,t.aircraft_code||t.aircraft_model].filter(Boolean);return q`
                <div class="row">
                  ...
                  <div class="info">
                    ...
                    ${s.length?q`<div class="det">${s.join(" · ")}</div>`:Y}
                  </div>
      ...
      <div class="card">
        <div class="head">
          ...
          <div class="who">
            ...
            <div class="sub">
              ${t.subtitle}${null!=s?q` · ${_t("wifi",14,s?"var(--g-green)":"var(--g-dim)")}${s?"Connected":"Offline"}`:Y}
            </div>
          </div>
        ...
        ${this._toggles.length?q`<div class="rows">
              ${this._toggles.map(e=>{const s=this.hass.states[e.entity],i="on"===s?.state;let a=e.name??s?.attributes.friendly_name??e.entity;t.name&&a.toLowerCase().startsWith(t.name.toLowerCase()+" ")&&(a=a.slice(t.name.length+1));const r=e.icon??(/cool/i.test(a)?"mode_cool":"bolt");return q`
                  <div class="row">
                    ${_t(r,22,i?"var(--g-cyan)":"var(--g-dim)")}
    ...
    `],e([mt({attribute:!1})],Gt.prototype,"hass",void 0),e([ft()],Gt.prototype,"_config",void 0),Gt=e([pt("glass-fridge-card")],Gt);const It={green:"var(--g-green)",amber:"var(--g-amber)",cyan:"var(--g-cyan)",purple:"var(--g-purple)",red:"var(--g-red-text)"};let qt=class extends dt{setConfig(t){this._config={name:"Pool Pump",subtitle:"Backyard",...t}}getCardSize(){return 3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{name:"Pool Pump",subtitle:"Backyard",switch:"",energy:""}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||[this._config.switch,this._config.energy].filter(Boolean).some(t=>e.states[t]!==this.hass.states[t])}_toggle(t){t.stopPropagation(),this._config.switch&&this.hass.callService("homeassistant","toggle",{entity_id:this._config.switch})}render(){if(!this._config||!this.hass)return Y;const t=this._config,e=t.switch?this.hass.states[t.switch]:void 0,s=!e||"unavailable"===e.state,i="on"===e?.state,a=It[t.color??"green"]??"var(--g-green)",r=s?"var(--g-dim)":i?a:"var(--g-amber)",n=s?"Unavailable":i?"Running":"Idle",o=t.energy?this.hass.states[t.energy]:void 0,l=o&&!Number.isNaN(Number(o.state))?Number(o.state).toFixed(1):"—",c=o?.attributes.unit_of_measurement??"kWh",d=i?"animation:g-spin 1.1s linear infinite;transform-origin:48px 48px;":"",g=i?"animation:g-spin 6s linear infinite;transform-origin:48px 48px;":"";return q`
      <div class="card" style="border-color:${i?`color-mix(in srgb, ${a} 30%, transparent)`:"var(--g-hair)"}">
        <div class="head">
          ...
          <div class="who">
            <div class="title">${t.name}${i?q` <span class="live">LIVE</span>`:Y}</div>
    ...
    `],e([mt({attribute:!1})],qt.prototype,"hass",void 0),e([ft()],qt.prototype,"_config",void 0),qt=e([pt("glass-pool-card")],qt);const Ft={door:"door_front",window:"window",connectivity:"wifi",running:"check_circle"};let Vt=class extends dt{setConfig(t){this._config={name:"Dishwasher",subtitle:"Kitchen",level_max:4,...t}}getCardSize(){return 3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{name:"Dishwasher",subtitle:"Kitchen",status:""}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");if(!e||!this.hass||!this._config)return!0;const s=this._config;return[s.status,s.alert,...s.tiles??[],...s.levels??[]].filter(Boolean).some(t=>e.states[t]!==this.hass.states[t])}_label(t){let e=this.hass.states[t]?.attributes.friendly_name??t;const s=this._config.name;return s&&e.toLowerCase().startsWith(s.toLowerCase()+" ")&&(e=e.slice(s.length+1)),e}_pretty(t){return t.replace(/_/g," ").replace(/^\w/,t=>t.toUpperCase())}_statusLook(t){const e=t.toLowerCase(),s=this._pretty(t);return/(run|washing|active|start)/.test(e)?{color:"var(--g-cyan)",label:s}:/(complete|finish|clean|done)/.test(e)?{color:"var(--g-green)",label:s}:/(pause|delay)/.test(e)?{color:"var(--g-amber)",label:s}:/(off|idle|power_off|standby)/.test(e)?{color:"var(--g-dim)",label:"Power off"}:{color:"var(--g-dim)",label:s}}_tile(t){const e=this.hass.states[t];if(!e)return Y;const s=e.attributes.device_class,i=t.split(".")[0];let a,r=!1;"binary_sensor"===i||"switch"===i?(r="on"===e.state,a="door"===s||"window"===s||"opening"===s?r?"Open":"Closed":"connectivity"===s?r?"Online":"Offline":r?"On":"Off"):a=this._pretty(e.state);return q`<div class="tile" @click=${()=>xt(this,"hass-more-info",{entityId:t})}>
      ...
      <div class="card">
        ...
        ${i?q`<div class="alert">${_t("opacity",22,"var(--g-amber)")}<div><div class="a-t">${t.alert_text??"Attention needed"}</div></div></div>`:Y}
    ...
    `],e([mt({attribute:!1})],Qt.prototype,"hass",void 0),e([ft()],Qt.prototype,"_config",void 0),Qt=e([pt("glass-lights-card")],Qt);const Xt={scene:"palette",script:"play_arrow",automation:"bolt"};let Zt=class extends dt{constructor(){super(...arguments),this._scenes=[]}setConfig(t){this._scenes=(t.scenes??[]).map(t=>"string"==typeof t?{entity:t}:t),this._config={columns:4,...t}}getCardSize(){return Math.ceil(this._scenes.length/(this._config?.columns??4))+1}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{scenes:[]}}shouldUpdate(){return!0}_activate(t){const e=t.split(".")[0],s="scene"===e?"scene.turn_on":"script"===e?"script.turn_on":"automation"===e?"automation.trigger":"homeassistant.turn_on",[i,a]=s.split(".");this.hass.callService(i,a,{entity_id:t})}render(){return this._config&&this.hass?this._scenes.length?q`
      <div class="card">
        ...
        <div class="grid" style="grid-template-columns:repeat(${this._config.columns}, 1fr)">
          ${this._scenes.map(t=>{const e=this.hass.states[t.entity],s=t.name??e?.attributes.friendly_name??t.entity,i=t.icon??Xt[t.entity.split(".")[0]]??"palette";return q`<button class="scene" @click=${()=>this._activate(t.entity)}>${_t(i,24,"var(--g-text-hi)")}<span class="sn">${s}</span></button>`})}
        </div>
      </div>
    ...
    `],e([mt({attribute:!1})],se.prototype,"hass",void 0),e([ft()],se.prototype,"_config",void 0),se=e([pt("glass-aircon-card")],se);let ie=class extends dt{constructor(){super(...arguments),this._modes=[]}setConfig(t){this._modes=(t.modes??[]).map(t=>"string"==typeof t?{entity:t}:t),this._config={name:"Geyser",subtitle:"Water heater",min_temp:20,max_temp:70,...t}}getCardSize(){return 3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{name:"Geyser",subtitle:"Bathroom",power:"",current:"",target:""}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");if(!e||!this.hass||!this._config)return!0;const s=this._config,i=[s.power,s.current,s.target,s.solar,s.power_sensor,s.solar_mode,...this._modes.map(t=>t.entity)].filter(Boolean);return i.some(t=>e.states[t]!==this.hass.states[t])}_num(t){const e=t?Number(this.hass.states[t]?.state):NaN;return Number.isNaN(e)?null:e}_isOn(t){if(!t)return!1;const e=this.hass.states[t];return!!e&&("on"===e.state||t.startsWith("water_heater.")&&"off"!==e.state)}_toggle(t,e){if(e.stopPropagation(),!t)return;const s=t.startsWith("water_heater.")?"water_heater":"homeassistant";this.hass.callService(s,"toggle",{entity_id:t})}_step(t,e){e.stopPropagation();const s=this._config.target;if(!s)return;const i=this.hass.states[s];if(!i)return;const a=s.split(".")[0];if("number"===a){const e=Number(i.state);if(Number.isNaN(e))return;const a=Number(i.attributes.min??this._config.min_temp??20),r=Number(i.attributes.max??this._config.max_temp??70),n=Number(i.attributes.step??1);this.hass.callService("number","set_value",{entity_id:s,value:Math.min(r,Math.max(a,e+t*n))})}else{const e=Number(i.attributes.temperature);if(Number.isNaN(e))return;const r=Number(i.attributes.target_temp_step??1);this.hass.callService(a,"set_temperature",{entity_id:s,temperature:e+t*r})}}_target(){const t=this._config.target;if(!t)return null;const e=this.hass.states[t];return e?t.startsWith("number.")?this._num(t):Number(e.attributes.temperature)||null:null}_fillColor(t){return`hsl(${Math.round(200-170*t)}, 72%, 52%)`}render(){if(!this._config||!this.hass)return Y;const t=this._config,e=this._isOn(t.power),s=this._num(t.current),i=this._target(),a=t.min_temp??20,r=t.max_temp??70,n=null!=s?Math.max(.05,Math.min(1,(s-a)/(r-a))):.5,o=e&&null!=s&&null!=i?s<i-.5:e,l=e?o?"#ff8c42":"var(--g-green)":"var(--g-dim)",c=e?o?"Heating":"Ready":"Off",d=o?"#ff8c42":"rgba(255,140,66,0.2)",g=this._isOn(t.solar_mode);return q`
      <div class="card">
        ...
        ${t.solar_mode||this._modes.length?q`<div class="modes">
              ...
              ${this._modes.map(t=>{const e=this._isOn(t.entity),s=t.name??this.hass.states[t.entity]?.attributes.friendly_name??t.entity;return q`<button class="mode ${e?"on":""}" @click=${e=>this._toggle(t.entity,e)}>${_t(t.icon??"bolt",18,e?"var(--g-amber-ink)":"var(--g-dim)")}${s}</button>`})}
            </div>`:Y}
      </div>
    `}};ie.styles=[$t,o`
    ...
    `],e([mt({attribute:!1})],ie.prototype,"hass",void 0),e([ft()],ie.prototype,"_config",void 0),ie=e([pt("glass-geyser-card")],ie);const ae={light:"lightbulb",switch:"toggle_on",fan:"mode_fan",input_boolean:"toggle_on",script:"play_arrow",automation:"bolt",scene:"palette"};let re=class extends dt{constructor(){super(...arguments),this._items=[]}setConfig(t){this._items=(t.entities??[]).map(t=>"string"==typeof t?{entity:t}:t),this._config={columns:4,...t}}getCardSize(){return Math.ceil(this._items.length/(this._config?.columns??4))+1}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entities:[]}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!e||!this.hass||this._items.some(t=>e.states[t.entity]!==this.hass.states[t.entity])}_toggle(t){this.hass.callService("homeassistant","toggle",{entity_id:t})}render(){return this._config&&this.hass?this._items.length?q`
      <div class="card">
        ...
        <div class="grid" style="grid-template-columns:repeat(${this._config.columns}, 1fr)">
          ${this._items.map(t=>{const e=this.hass.states[t.entity],s=e&&("on"===e.state||"open"===e.state||"home"===e.state||"playing"===e.state),i=t.entity.split(".")[0],a=t.icon??ae[i]??"circle",r=t.name??e?.attributes.friendly_name??t.entity,n=e?s?"On":"off"===e.state?"Off":e.state:"n/a";return q`
              <button class="q ${s?"on":""}" @click=${()=>this._toggle(t.entity)} title=${r}>
                ${_t(a,22,s?"var(--g-amber-ink)":"var(--g-dim)")}
    ...
    `],e([mt({attribute:!1})],re.prototype,"hass",void 0),e([ft()],re.prototype,"_config",void 0),re=e([pt("glass-toggle-grid-card")],re);const ne={heat:{icon:"local_fire_department",color:"var(--g-amber)",label:"Heat"},cool:{icon:"ac_unit",color:"var(--g-cyan)",label:"Cool"},auto:{icon:"autorenew",color:"var(--g-green)",label:"Auto"},heat_cool:{icon:"device_thermostat",color:"var(--g-green)",label:"Auto"},off:{icon:"power_settings_new",color:"var(--g-dim)",label:"Off"}};let oe=class extends dt{setConfig(t){this._config=t}getCardSize(){return 3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entity:"",name:"Heat Pump",subtitle:"Pool heater"}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||e.states[this._config.entity]!==this.hass.states[this._config.entity]}get _st(){return this._config.entity?this.hass.states[this._config.entity]:void 0}_step(t,e){e.stopPropagation();const s=this._st.attributes,i=Number(s.target_temp_step??.5),a=Number(s.temperature);if(Number.isNaN(a))return;const r=Number(s.min_temp??15),n=Number(s.max_temp??40);this.hass.callService("climate","set_temperature",{entity_id:this._config.entity,temperature:Math.min(n,Math.max(r,a+t*i))})}_setMode(t){this.hass.callService("climate","set_hvac_mode",{entity_id:this._config.entity,hvac_mode:t})}_toggle(t){t.stopPropagation();if("off"!==this._st.state)this._setMode("off");else{const t=this._st.attributes.hvac_modes??[];this._setMode(t.find(t=>"off"!==t)??"heat")}}render(){if(!this._config||!this.hass)return Y;const t=this._st;if(!t)return yt("Select a heat-pump (climate) entity","heat_pump");const e=t.attributes,s=t.state,i="off"!==s,a=ne[s]??ne.off,r=this._config.name??e.friendly_name??"Heat Pump",n=null!=e.temperature?Number(e.temperature):null,o=Number(e.min_temp??15),l=Number(e.max_temp??40),c=null!=n?Math.max(0,Math.min(100,(n-o)/(l-o)*100)):0,d=(e.hvac_action??s).replace(/_/g," "),g=(e.hvac_modes??[]).filter(t=>["heat","cool","auto","heat_cool"].includes(t));return q`
      <div class="card">
        ...
        ${g.length?q`<div class="seg">
              ${g.map(t=>{const e=ne[t]??ne.off;return q`<button class="sg ${s===t?"on":""}" @click=${()=>this._setMode(t)}>${_t(e.icon,17)}${e.label}</button>`})}
            </div>`:Y}
      </div>
    `}};oe.styles=[$t,o`
      .card { display: flex; flex-direction: column; gap: 18px; }
    ...
    `],e([mt({attribute:!1})],ce.prototype,"hass",void 0),e([ft()],ce.prototype,"_config",void 0),ce=e([pt("glass-nav-card")],ce);let de=class extends dt{setConfig(t){this._config={variant:"full",...t}}getCardSize(){return"compact"===this._config?.variant?1:4}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entity:"",variant:"full"}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||e.states[this._config.entity]!==this.hass.states[this._config.entity]}get _st(){return this._config.entity?this.hass.states[this._config.entity]:void 0}_openPct(){const t=this._st,e=t.attributes.current_position;return null==e||Number.isNaN(Number(e))?"open"===t.state?100:"opening"===t.state?60:"closing"===t.state?40:0:Number(e)}_look(){const t=this._st.state;return"open"===t?{color:"var(--g-amber)",label:"Open",icon:"garage_home"}:"opening"===t||"closing"===t?{color:"var(--g-amber)",label:"opening"===t?"Opening…":"Closing…",icon:"garage_home",moving:!0}:{color:"var(--g-green)",label:"Closed",icon:"garage"}}_toggle(t){t.stopPropagation();const e=this._st.state,s="open"===e||"opening"===e?"close_cover":"open_cover";this.hass.callService("cover",s,{entity_id:this._config.entity})}render(){if(!this._config||!this.hass)return Y;if(!this._st)return yt("Select a garage door (cover) entity","garage");const t=this._look(),e=this._openPct(),s=this._config.name??this._st.attributes.friendly_name??"Garage";if("compact"===this._config.variant)return q`
        <button class="tile" @click=${this._toggle} title=${s}>
          <div class="top">
            <div class="mini">
          ...
          <div><div class="tn">${s}</div><div class="ts" style="color:${t.color}">${t.label}</div></div>
        </button>
      `;const i=e>5;return q`
      <div class="card">
        <div class="head">
          <div class="ibox" style="background:color-mix(in srgb, ${t.color} 14%, transparent)">${_t(t.icon,26,t.color)}</div>
          <div class="who"><div class="title">${s}</div><div class="sub">${this._config.subtitle??this._config.entity}</div></div>
          <span class="pill" style="color:${t.color}"><span class="dot" style="background:${t.color}"></span>${t.label}</span>
        </div>

        <div class="stage">
          <div class="interior"></div>
          <div class="car" style="opacity:${i?.9:0}">
        ...
        <button class="btn ${"var(--g-amber)"===t.color?"primary":"soft"}" @click=${this._toggle}>
          ${_t(t.moving?"autorenew":i?"arrow_downward":"arrow_upward",20)}${i?"Close":"Open"}
        </button>
      </div>
    `}};de.styles=[$t,o`
      @keyframes g-spin { to { transform: rotate(360deg); } }
    ...
    `],e([mt({attribute:!1})],de.prototype,"hass",void 0),e([ft()],de.prototype,"_config",void 0),de=e([pt("glass-garage-card")],de);const ge=(t,e=!1)=>({entity:{...t?{domain:t}:{},...e?{multiple:!0}:{}}}),pe={text:{}},he=(t,e)=>({number:{min:t,max:e,mode:"box"}}),ue=t=>({select:{mode:"dropdown",options:t}}),me={"glass-person-card":[{name:"title",selector:pe},{name:"entities",required:!0,selector:ge("person",!0)}],"glass-weather-card":[{name:"entity",required:!0,selector:ge("weather")},{name:"sun",selector:ge("sun")},{name:"humidity",selector:ge("sensor")}],"glass-camera-card":[{name:"entity",required:!0,selector:ge("camera")},{name:"name",selector:pe},{name:"icon",selector:pe}],"glass-alarm-card":[{name:"entity",required:!0,selector:ge("alarm_control_panel")},{name:"variant",selector:ue([{value:"shield",label:"Shield (default)"},{value:"radial",label:"Radial"},{value:"bar",label:"Compact bar"},{value:"keypad",label:"Keypad"},{value:"triggered",label:"Triggered / status"}])},{name:"name",selector:pe},{name:"subtitle",selector:pe},{name:"code",selector:pe},{name:"code_length",selector:he(1,8)},{name:"buttons",selector:{select:{multiple:!0,mode:"list",options:[{value:"disarm",label:"Disarm"},{value:"arm_home",label:"Arm Home"},{value:"arm_away",label:"Arm Away"},{value:"arm_night",label:"Arm Night"},{value:"arm_vacation",label:"Arm Vacation"}]}}}],"glass-media-card":[{name:"entity",required:!0,selector:ge("media_player")},{name:"name",selector:pe}],"glass-flight-card":[{name:"entity",required:!0,selector:ge("sensor")},{name:"title",selector:pe},{name:"max",selector:he(1,10)}],"glass-tile-card":[{name:"entity",required:!0,selector:ge()},{name:"name",selector:pe},{name:"icon",selector:pe}],"glass-energy-card":[{name:"title",selector:pe},{name:"variant",selector:ue([{value:"flow",label:"Power flow (default)"},{value:"ring",label:"Battery ring"},{value:"stats",label:"Stat trio"},{value:"meters",label:"Meters"},{value:"production",label:"Production bars"}])},{name:"solar",selector:ge("sensor")},{name:"grid",selector:ge("sensor")},{name:"battery",selector:ge("sensor")},{name:"battery_soc",selector:ge("sensor")},{name:"house",selector:ge("sensor")},{name:"today",selector:ge("sensor")},{name:"imported",selector:ge("sensor")},{name:"exported",selector:ge("sensor")},{name:"saved",selector:ge("sensor")},{name:"meters",selector:ge("sensor",!0)},{name:"production",selector:ge("sensor")}],"glass-sensor-list-card":[{name:"title",selector:pe},{name:"entities",required:!0,selector:ge(["cover","binary_sensor"],!0)}],"glass-appliance-card":[{name:"name",selector:pe},{name:"subtitle",selector:pe},{name:"icon",selector:pe},{name:"icon_color",selector:{select:{mode:"dropdown",options:["cyan","amber","green","purple","red"]}}},{name:"status",selector:ge(["sensor","binary_sensor"])},{name:"remaining",selector:ge("sensor")},{name:"total",selector:ge("sensor")},{name:"toggle",selector:ge(["switch","input_boolean"])},{name:"stats",selector:ge(["sensor","binary_sensor","number"],!0)}],"glass-fridge-card":[{name:"name",selector:pe},{name:"subtitle",selector:pe},{name:"door",selector:ge("binary_sensor")},{name:"wifi",selector:ge("binary_sensor")},{name:"fridge_temp",selector:ge("number")},{name:"freezer_temp",selector:ge("number")},{name:"toggles",selector:ge(["switch","input_boolean"],!0)}],"glass-pool-card":[{name:"name",selector:pe},{name:"subtitle",selector:pe},{name:"switch",selector:ge(["switch","input_boolean"])},{name:"energy",selector:ge("sensor")},{name:"color",selector:ue(["green","amber","cyan","purple","red"])}],"glass-stat-card":[{name:"entity",required:!0,selector:ge()},{name:"name",selector:pe},{name:"icon",selector:pe},{name:"color",selector:ue(["amber","green","cyan","purple","red","dim"])}],"glass-lights-card":[{name:"title",selector:pe},{name:"entities",required:!0,selector:ge("light",!0)}],"glass-scenes-card":[{name:"title",selector:pe},{name:"columns",selector:he(2,6)},{name:"scenes",required:!0,selector:ge(["scene","script","automation"],!0)}],"glass-toggle-grid-card":[{name:"title",selector:pe},{name:"columns",selector:he(2,8)},{name:"entities",required:!0,selector:ge(["light","switch","fan","input_boolean","script","scene"],!0)}],"glass-heatpump-card":[{name:"entity",required:!0,selector:ge("climate")},{name:"name",selector:pe},{name:"subtitle",selector:pe}],"glass-garage-card":[{name:"entity",required:!0,selector:ge("cover")},{name:"variant",selector:ue([{value:"full",label:"Full (animated visual)"},{value:"compact",label:"Compact tile"}])},{name:"name",selector:pe},{name:"subtitle",selector:pe}],"glass-water-chemistry-card":[{name:"title",selector:pe},{name:"metrics",selector:ge("sensor",!0)}],"glass-nav-card":[{name:"variant",selector:ue([{value:"dock",label:"Full-width dock"},{value:"pill",label:"Floating pill"}])},{name:"fixed",selector:{boolean:{}}},{name:"max_width",selector:he(320,1600)}],"glass-light-card":[{name:"entity",required:!0,selector:ge("light")},{name:"name",selector:pe},{name:"subtitle",selector:pe}],"glass-aircon-card":[{name:"entity",required:!0,selector:ge("climate")},{name:"name",selector:pe},{name:"subtitle",selector:pe}],"glass-geyser-card":[{name:"name",selector:pe},{name:"subtitle",selector:pe},{name:"power",selector:ge(["switch","input_boolean","water_heater"])},{name:"current",selector:ge("sensor")},{name:"target",selector:ge(["number","water_heater","climate"])},{name:"min_temp",selector:he(0,100)},{name:"max_temp",selector:he(0,100)},{name:"solar",selector:ge("sensor")},{name:"power_sensor",selector:ge("sensor")},{name:"solar_mode",selector:ge(["switch","input_boolean"])},{name:"modes",selector:ge(["switch","input_boolean"],!0)}],"glass-dishwasher-card":[{name:"name",selector:pe},{name:"subtitle",selector:pe},{name:"status",selector:ge("sensor")},{name:"alert",selector:ge("binary_sensor")},{name:"alert_text",selector:pe},{name:"tiles",selector:ge(["binary_sensor","sensor"],!0)},{name:"levels",selector:ge("sensor",!0)},{name:"level_max",selector:he(1,10)}]},fe={entity:"Entity",entities:"Entities",title:"Title",name:"Name (optional)",icon:"Icon (optional)",sun:"Sun entity (for sunrise/sunset)",humidity:"Humidity sensor (optional)",code:"Arm/disarm code (optional)",max:"Max flights to show",buttons:"Action buttons to show",variant:"Layout / style",code_length:"Keypad code length",today:"Solar-today energy sensor (big number)",imported:"Imported-today sensor",exported:"Exported-today sensor",saved:"Money-saved sensor",meters:"Percentage sensors to show as meters",production:"Production sensor for hourly bars (needs statistics)",subtitle:"Subtitle (e.g. room/area)",icon_color:"Icon accent colour",status:"Status sensor (drives the pill)",remaining:"Remaining-time sensor (timestamp → progress ring)",total:"Total-time sensor (minutes, for the ring %)",toggle:"Power switch (optional on/off button)",stats:"Extra sensors shown as stat tiles",door:"Door sensor",wifi:"Wi-Fi / connectivity sensor (optional)",fridge_temp:"Fridge temperature (number entity)",freezer_temp:"Freezer temperature (number entity)",toggles:"Feature switches (Express cool/mode, etc.)",switch:"Pump switch",energy:"Energy sensor (kWh)",color:"Accent colour",columns:"Columns",scenes:"Scenes / scripts to show",alert:"Alert sensor (e.g. refill needed)",alert_text:"Alert message",tiles:"Status tiles",levels:"Level sensors (shown as bars)",level_max:"Level bar maximum",power:"Power switch (on/off)",current:"Current temperature sensor",target:"Target temperature (number / thermostat)",min_temp:"Minimum temperature",max_temp:"Maximum temperature",solar:"Solar collector temperature sensor",power_sensor:"Power draw sensor (kW)",solar_mode:"Solar mode switch (toggleable)",modes:"Extra mode switches (boost, element, timer)",metrics:"Water metric sensors (pH, chlorine, …)",fixed:"Stick to bottom of screen",max_width:"Maximum width (px)",solar:"Solar power sensor",grid:"Grid power sensor (+import / −export)",battery:"Battery power sensor (+discharge / −charge)",battery_soc:"Battery charge % sensor",house:"House load sensor (optional; derived if empty)"},ve={icon:"Material Symbols name, e.g. lightbulb, garage, kitchen",code:"Only if your panel requires a code to arm/disarm"};let be=class extends dt{constructor(){super(...arguments),this._label=t=>fe[t.name]??t.name,this._helper=t=>ve[t.name]??""}setConfig(t){this._config=t}_valueChanged(t){if(t.stopPropagation(),!this._config)return;const e={...this._config,...t.detail.value,type:this._config.type};xt(this,"config-changed",{config:e})}render(){if(!this.hass||!this._config)return Y;const t=this._config.type.replace(/^custom:/,""),e=me[t];return e?q`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${e}
