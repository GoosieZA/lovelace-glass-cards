...
`;let wt=class extends dt{setConfig(t){this._config={title:"Home",entities:[],...t}}getCardSize(){return 2}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{title:"Home",entities:[]}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||this._config.entities.some(t=>e.states[t]!==this.hass.states[t])}_statusOf(t){const e=this.hass?.states[t];if(!e)return{label:"Unknown",home:!1,accent:"var(--g-dim)"};if("home"===e.state)return{label:"Home",home:!0,accent:"var(--g-green)"};if("not_home"===e.state)return{label:"Away",home:!1,accent:"var(--g-dim)"};return{label:e.state.charAt(0).toUpperCase()+e.state.slice(1),home:!1,accent:"var(--g-amber)"}}_relTime(t){if(!t)return"";const e=Math.round((Date.now()-new Date(t).getTime())/6e4);if(e<1)return"just now";if(e<60)return`${e}m ago`;const i=Math.round(e/60);return i<24?`${i}h ago`:`${Math.round(i/24)}d ago`}_open(t){xt(this,"hass-more-info",{entityId:t})}render(){if(!this._config||!this.hass)return Y;if(!this._config.entities.length)return yt("Add person entities","group");const t=this._config.entities.map(t=>({id:t,st:this.hass.states[t]})),e=t.filter(t=>"home"===t.st?.state).length;return q`
      ...
      <div class="card" @click=${()=>xt(this,"hass-more-info",{entityId:this._config.entity})}>
        ...
        <div class="tiles">
          ...
          <div class="tile">
            ...
            <div class="t-num tile-v">${this._time(h?g:p)}</div>
          </div>
        </div>
      </div>
    `}};Ct.styles=[$t,o`
      ...
      <div class="flow">
        <svg viewBox="0 0 408 264" preserveAspectRatio="xMidYMid meet">
          ${F`
            ...
            <path d="M204 58 L204 108" fill="none" stroke-width="3.5" stroke-linecap="round" stroke-dasharray="2 12" style=${p(r,"var(--g-amber)")}></path>
            <path d="M92 176 L166 148" fill="none" stroke-width="3.5" stroke-linecap="round" stroke-dasharray="2 12" style=${p(n||o,"var(--g-purple)",o)}></path>
            <path d="M242 148 L316 176" fill="none" stroke-width="3.5" stroke-linecap="round" stroke-dasharray="2 12" style=${p(l||c,"var(--g-green)",c)}></path>
          `}
        </svg>
    ...
    `],e([mt({attribute:!1})],Gt.prototype,"hass",void 0),e([ft()],Gt.prototype,"_config",void 0),Gt=e([gt("glass-fridge-card")],Gt);const It={green:"var(--g-green)",amber:"var(--g-amber)",cyan:"var(--g-cyan)",purple:"var(--g-purple)",red:"var(--g-red-text)"};let qt=class extends dt{setConfig(t){this._config={name:"Pool Pump",subtitle:"Backyard",...t}}getCardSize(){return 3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{name:"Pool Pump",subtitle:"Backyard",switch:"",energy:""}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||[this._config.switch,this._config.energy].filter(Boolean).some(t=>e.states[t]!==this.hass.states[t])}_toggle(t){t.stopPropagation(),this._config.switch&&this.hass.callService("homeassistant","toggle",{entity_id:this._config.switch})}render(){if(!this._config||!this.hass)return Y;const t=this._config,e=t.switch?this.hass.states[t.switch]:void 0,i=!e||"unavailable"===e.state,s="on"===e?.state,a=It[t.color??"green"]??"var(--g-green)",r=i?"var(--g-dim)":s?a:"var(--g-amber)",n=i?"Unavailable":s?"Running":"Idle",o=t.energy?this.hass.states[t.energy]:void 0,l=o&&!Number.isNaN(Number(o.state))?Number(o.state).toFixed(1):"—",c=o?.attributes.unit_of_measurement??"kWh",d=s?"animation:g-spin 1.1s linear infinite;transform-origin:48px 48px;":"",p=s?"animation:g-spin 6s linear infinite;transform-origin:48px 48px;":"";return q`
          ...
          <div class="impeller">
            <svg viewBox="0 0 96 96" width="96" height="96">
              ${F`
                ...
                <g fill="none" stroke="${r}" stroke-width="2.5" stroke-linecap="round" stroke-dasharray="4 10" style="${p}">
    ...
    `],e([mt({attribute:!1})],Qt.prototype,"hass",void 0),e([ft()],Qt.prototype,"_config",void 0),Qt=e([gt("glass-lights-card")],Qt);const Xt={scene:"palette",script:"play_arrow",automation:"bolt"};let Zt=class extends dt{constructor(){super(...arguments),this._scenes=[]}setConfig(t){this._scenes=(t.scenes??[]).map(t=>"string"==typeof t?{entity:t}:t),this._config={columns:4,...t}}getCardSize(){return Math.ceil(this._scenes.length/(this._config?.columns??4))+1}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{scenes:[]}}shouldUpdate(){return!0}_activate(t){const e=t.split(".")[0],i="scene"===e?"scene.turn_on":"script"===e?"script.turn_on":"automation"===e?"automation.trigger":"homeassistant.turn_on",[s,a]=i.split(".");this.hass.callService(s,a,{entity_id:t})}render(){return this._config&&this.hass?this._scenes.length?q`
      <div class="card">
        ...
        <div class="grid" style="grid-template-columns:repeat(${this._config.columns}, minmax(0, 1fr))">
          ${this._scenes.map(t=>{const e=this.hass.states[t.entity],i=t.name??e?.attributes.friendly_name??t.entity,s=t.icon??Xt[t.entity.split(".")[0]]??"palette";return q`<button class="scene" @click=${()=>this._activate(t.entity)}>${_t(s,24,"var(--g-text-hi)")}<span class="sn">${i}</span></button>`})}
        </div>
      </div>
    ...
    `],e([mt({attribute:!1})],ie.prototype,"hass",void 0),e([ft()],ie.prototype,"_config",void 0),ie=e([gt("glass-aircon-card")],ie);let se=class extends dt{constructor(){super(...arguments),this._modes=[],this._optimisticOn=null,this._optimisticTimer=null}setConfig(t){this._modes=(t.modes??[]).map(t=>"string"==typeof t?{entity:t}:t),this._config={name:"Geyser",subtitle:"Water heater",min_temp:20,max_temp:70,...t}}getCardSize(){return 3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{name:"Geyser",subtitle:"Bathroom",power:"",current:"",target:""}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");if(!e||!this.hass||!this._config)return!0;const i=this._config,s=[i.power,i.current,i.target,i.solar,i.power_sensor,i.solar_mode,...this._modes.map(t=>t.entity)].filter(Boolean);return s.some(t=>e.states[t]!==this.hass.states[t])}updated(t){if(t.has("hass")&&null!==this._optimisticOn&&this._config?.power){const e=this._config.power,i=t.get("hass")?.states[e],s=this.hass?.states[e];i!==s&&(null!==this._optimisticTimer&&(clearTimeout(this._optimisticTimer),this._optimisticTimer=null),this._optimisticOn=null)}}_num(t){const e=t?Number(this.hass.states[t]?.state):NaN;return Number.isNaN(e)?null:e}_isOn(t){if(!t)return!1;const e=this.hass.states[t];return!!e&&("on"===e.state||t.startsWith("water_heater.")&&"off"!==e.state)}_toggle(t,e){if(e.stopPropagation(),!t)return;const i=this._isOn(t);t===this._config?.power&&(this._optimisticOn=!i,null!==this._optimisticTimer&&clearTimeout(this._optimisticTimer),this._optimisticTimer=setTimeout(()=>{this._optimisticOn=null,this._optimisticTimer=null},5e3)),t.startsWith("water_heater.")?this.hass.callService("water_heater",i?"turn_off":"turn_on",{entity_id:t}):this.hass.callService("homeassistant","toggle",{entity_id:t})}_step(t,e){e.stopPropagation();const i=this._config.target;if(!i)return;const s=this.hass.states[i];if(!s)return;const a=i.split(".")[0];if("number"===a){const e=Number(s.state);if(Number.isNaN(e))return;const a=Number(s.attributes.min??this._config.min_temp??20),r=Number(s.attributes.max??this._config.max_temp??70),n=Number(s.attributes.step??1);this.hass.callService("number","set_value",{entity_id:i,value:Math.min(r,Math.max(a,e+t*n))})}else{const e=Number(s.attributes.temperature);if(Number.isNaN(e))return;const r=Number(s.attributes.target_temp_step??1);this.hass.callService(a,"set_temperature",{entity_id:i,temperature:e+t*r})}}_target(){const t=this._config.target;if(!t)return null;const e=this.hass.states[t];return e?t.startsWith("number.")?this._num(t):Number(e.attributes.temperature)||null:null}_fillColor(t){return`hsl(${Math.round(200-170*t)}, 72%, 52%)`}render(){if(!this._config||!this.hass)return Y;const t=this._config,e=null!==this._optimisticOn?this._optimisticOn:this._isOn(t.power),i=this._num(t.current),s=this._target(),a=t.min_temp??20,r=t.max_temp??70,n=null!=i?Math.max(.05,Math.min(1,(i-a)/(r-a))):.5,o=e&&null!=i&&null!=s?i<s-.5:e,l=e?o?"#ff8c42":"var(--g-green)":"var(--g-dim)",c=e?o?"Heating":"Ready":"Off",d=o?"#ff8c42":"rgba(255,140,66,0.2)",p=this._isOn(t.solar_mode);return q`
      <div class="card">
        ...
        ${t.solar_mode||this._modes.length?q`<div class="modes">
              ${t.solar_mode?q`<button class="mode ${p?"on":""}" @click=${e=>this._toggle(t.solar_mode,e)}>${_t("wb_sunny",18,p?"var(--g-amber-ink)":"var(--g-amber)")}Solar</button>`:Y}
    ...
    `],e([mt({attribute:!1})],se.prototype,"hass",void 0),e([ft()],se.prototype,"_config",void 0),e([ft()],se.prototype,"_optimisticOn",void 0),se=e([gt("glass-geyser-card")],se);const ae={light:"lightbulb",switch:"toggle_on",fan:"mode_fan",input_boolean:"toggle_on",script:"play_arrow",automation:"bolt",scene:"palette"};let re=class extends dt{constructor(){super(...arguments),this._items=[]}setConfig(t){this._items=(t.entities??[]).map(t=>"string"==typeof t?{entity:t}:t),this._config={columns:4,...t}}getCardSize(){return Math.ceil(this._items.length/(this._config?.columns??4))+1}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entities:[]}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!e||!this.hass||this._items.some(t=>e.states[t.entity]!==this.hass.states[t.entity])}_toggle(t){this.hass.callService("homeassistant","toggle",{entity_id:t})}render(){return this._config&&this.hass?this._items.length?q`
      <div class="card">
    ...
    `],e([mt({attribute:!1})],re.prototype,"hass",void 0),e([ft()],re.prototype,"_config",void 0),re=e([gt("glass-toggle-grid-card")],re);const ne={heat:{icon:"local_fire_department",color:"var(--g-amber)",label:"Heat"},cool:{icon:"ac_unit",color:"var(--g-cyan)",label:"Cool"},auto:{icon:"autorenew",color:"var(--g-green)",label:"Auto"},heat_cool:{icon:"device_thermostat",color:"var(--g-green)",label:"Auto"},off:{icon:"power_settings_new",color:"var(--g-dim)",label:"Off"}};let oe=class extends dt{setConfig(t){this._config=t}getCardSize(){return 3}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entity:"",name:"Heat Pump",subtitle:"Pool heater"}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||e.states[this._config.entity]!==this.hass.states[this._config.entity]}get _st(){return this._config.entity?this.hass.states[this._config.entity]:void 0}_step(t,e){e.stopPropagation();const i=this._st.attributes,s=Number(i.target_temp_step??.5),a=Number(i.temperature);if(Number.isNaN(a))return;const r=Number(i.min_temp??15),n=Number(i.max_temp??40);this.hass.callService("climate","set_temperature",{entity_id:this._config.entity,temperature:Math.min(n,Math.max(r,a+t*s))})}_setMode(t){this.hass.callService("climate","set_hvac_mode",{entity_id:this._config.entity,hvac_mode:t})}_toggle(t){t.stopPropagation();if("off"!==this._st.state)this._setMode("off");else{const t=this._st.attributes.hvac_modes??[];this._setMode(t.find(t=>"off"!==t)??"heat")}}render(){if(!this._config||!this.hass)return Y;const t=this._st;if(!t)return yt("Select a heat-pump (climate) entity","heat_pump");const e=t.attributes,i=t.state,s="off"!==i,a=ne[i]??ne.off,r=this._config.name??e.friendly_name??"Heat Pump",n=null!=e.temperature?Number(e.temperature):null,o=Number(e.min_temp??15),l=Number(e.max_temp??40),c=null!=n?Math.max(0,Math.min(100,(n-o)/(l-o)*100)):0,d=(e.hvac_action??i).replace(/_/g," "),p=(e.hvac_modes??[]).filter(t=>["heat","cool","auto","heat_cool"].includes(t));return q`
      <div class="card">
        ...
        ${p.length?q`<div class="seg">
              ${p.map(t=>{const e=ne[t]??ne.off;return q`<button class="sg ${i===t?"on":""}" @click=${()=>this._setMode(t)}>${_t(e.icon,17)}${e.label}</button>`})}
            </div>`:Y}
      </div>
    `}};oe.styles=[$t,o`
      .card { display: flex; flex-direction: column; gap: 18px; }
    ...
    `],e([mt({attribute:!1})],oe.prototype,"hass",void 0),e([ft()],oe.prototype,"_config",void 0),oe=e([gt("glass-heatpump-card")],oe);let le=class extends dt{constructor(){super(...arguments),this._metrics=[]}setConfig(t){this._metrics=(t.metrics??[]).map(t=>"string"==typeof t?{entity:t}:t),this._config={title:"Water Chemistry",...t}}getCardSize(){return this._metrics.length+1}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{title:"Water Chemistry",metrics:[]}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!e||!this.hass||this._metrics.some(t=>e.states[t.entity]!==this.hass.states[t.entity])}_row(t){const e=this.hass.states[t.entity];if(!e)return q`<div class="row"><div class="miss">${t.entity} not found</div></div>`;const i=Number(e.state),s=!Number.isNaN(i),a=t.unit??e.attributes.unit_of_measurement??"",r=t.label??e.attributes.friendly_name??t.entity,n=t.color??"var(--g-cyan)",o=t.min??0,l=t.max??(s?Math.max(2*i,1):100),c=s?Math.max(0,Math.min(100,(i-o)/(l-o)*100)):0;let d=null;null==t.ok_min&&null==t.ok_max||(d=s&&(null==t.ok_min||i>=t.ok_min)&&(null==t.ok_max||i<=t.ok_max)?{label:"OK",cls:"green"}:s&&null!=t.ok_min&&i<t.ok_min?{label:"Low",cls:"amber"}:{label:"High",cls:"red"});const p=null!=t.ok_min?Math.max(0,Math.min(100,(t.ok_min-o)/(l-o)*100)):0,g=null!=t.ok_max?Math.max(0,Math.min(100,(t.ok_max-o)/(l-o)*100)):100;return q`
      <div class="row" @click=${()=>xt(this,"hass-more-info",{entityId:t.entity})}>
        ...
        <div class="body">
          ...
          <div class="bar">
            <div class="zone" style="left:${p}%;right:${100-g}%"></div>
    ...
    `],e([mt({attribute:!1})],ce.prototype,"hass",void 0),e([ft()],ce.prototype,"_config",void 0),ce=e([gt("glass-nav-card")],ce);let de=class extends dt{setConfig(t){this._config={variant:"full",...t}}getCardSize(){return"compact"===this._config?.variant?1:4}static getConfigElement(){return document.createElement("glass-config-editor")}static getStubConfig(){return{entity:"",variant:"full"}}shouldUpdate(t){if(t.has("_config"))return!0;const e=t.get("hass");return!(e&&this.hass&&this._config)||e.states[this._config.entity]!==this.hass.states[this._config.entity]}get _st(){return this._config.entity?this.hass.states[this._config.entity]:void 0}_openPct(){const t=this._st,e=t.attributes.current_position;return null==e||Number.isNaN(Number(e))?"open"===t.state?100:"opening"===t.state?60:"closing"===t.state?40:0:Number(e)}_look(){const t=this._st.state;return"open"===t?{color:"var(--g-amber)",label:"Open",icon:"garage_home"}:"opening"===t||"closing"===t?{color:"var(--g-amber)",label:"opening"===t?"Opening…":"Closing…",icon:"garage_home",moving:!0}:{color:"var(--g-green)",label:"Closed",icon:"garage"}}_toggle(t){t.stopPropagation();const e=this._st.state,i="open"===e||"opening"===e?"close_cover":"open_cover";this.hass.callService("cover",i,{entity_id:this._config.entity})}render(){if(!this._config||!this.hass)return Y;if(!this._st)return yt("Select a garage door (cover) entity","garage");const t=this._look(),e=this._openPct(),i=this._config.name??this._st.attributes.friendly_name??"Garage";if("compact"===this._config.variant)return q`
      ...
      <div class="card">
        ...
        <div class="stage">
          ...
          <div class="car" style="opacity:${s?.9:0}">
        ...
        <button class="btn ${"var(--g-amber)"===t.color?"primary":"soft"}" @click=${this._toggle}>
          ${_t(t.moving?"autorenew":s?"arrow_downward":"arrow_upward",20)}${s?"Close":"Open"}
        </button>
      </div>
    `}};de.styles=[$t,o`
      @keyframes g-spin { to { transform: rotate(360deg); } }
    ...
    `],e([mt({attribute:!1})],de.prototype,"hass",void 0),e([ft()],de.prototype,"_config",void 0),de=e([gt("glass-garage-card")],de);const pe=(t,e=!1)=>({entity:{...t?{domain:t}:{},...e?{multiple:!0}:{}}}),ge={text:{}},he=(t,e)=>({number:{min:t,max:e,mode:"box"}}),ue=t=>({select:{mode:"dropdown",options:t}}),me={"glass-person-card":[{name:"title",selector:ge},{name:"entities",required:!0,selector:pe("person",!0)}],"glass-weather-card":[{name:"entity",required:!0,selector:pe("weather")},{name:"sun",selector:pe("sun")},{name:"humidity",selector:pe("sensor")}],"glass-camera-card":[{name:"entity",required:!0,selector:pe("camera")},{name:"name",selector:ge},{name:"icon",selector:ge}],"glass-alarm-card":[{name:"entity",required:!0,selector:pe("alarm_control_panel")},{name:"variant",selector:ue([{value:"shield",label:"Shield (default)"},{value:"radial",label:"Radial"},{value:"bar",label:"Compact bar"},{value:"keypad",label:"Keypad"},{value:"triggered",label:"Triggered / status"}])},{name:"name",selector:ge},{name:"subtitle",selector:ge},{name:"code",selector:ge},{name:"code_length",selector:he(1,8)},{name:"buttons",selector:{select:{multiple:!0,mode:"list",options:[{value:"disarm",label:"Disarm"},{value:"arm_home",label:"Arm Home"},{value:"arm_away",label:"Arm Away"},{value:"arm_night",label:"Arm Night"},{value:"arm_vacation",label:"Arm Vacation"}]}}}],"glass-media-card":[{name:"entity",required:!0,selector:pe("media_player")},{name:"name",selector:ge}],"glass-flight-card":[{name:"entity",required:!0,selector:pe("sensor")},{name:"title",selector:ge},{name:"max",selector:he(1,10)}],"glass-tile-card":[{name:"entity",required:!0,selector:pe()},{name:"name",selector:ge},{name:"icon",selector:ge}],"glass-energy-card":[{name:"title",selector:ge},{name:"variant",selector:ue([{value:"flow",label:"Power flow (default)"},{value:"ring",label:"Battery ring"},{value:"stats",label:"Stat trio"},{value:"meters",label:"Meters"},{value:"production",label:"Production bars"}])},{name:"solar",selector:pe("sensor")},{name:"grid",selector:pe("sensor")},{name:"battery",selector:pe("sensor")},{name:"battery_soc",selector:pe("sensor")},{name:"house",selector:pe("sensor")},{name:"today",selector:pe("sensor")},{name:"imported",selector:pe("sensor")},{name:"exported",selector:pe("sensor")},{name:"saved",selector:pe("sensor")},{name:"meters",selector:pe("sensor",!0)},{name:"production",selector:pe("sensor")}],"glass-sensor-list-card":[{name:"title",selector:ge},{name:"entities",required:!0,selector:pe(["cover","binary_sensor"],!0)}],"glass-appliance-card":[{name:"name",selector:ge},{name:"subtitle",selector:ge},{name:"icon",selector:ge},{name:"icon_color",selector:{select:{mode:"dropdown",options:["cyan","amber","green","purple","red"]}}},{name:"status",selector:pe(["sensor","binary_sensor"])},{name:"remaining",selector:pe("sensor")},{name:"total",selector:pe("sensor")},{name:"toggle",selector:pe(["switch","input_boolean"])},{name:"stats",selector:pe(["sensor","binary_sensor","number"],!0)}],"glass-fridge-card":[{name:"name",selector:ge},{name:"subtitle",selector:ge},{name:"door",selector:pe("binary_sensor")},{name:"wifi",selector:pe("binary_sensor")},{name:"fridge_temp",selector:pe("number")},{name:"freezer_temp",selector:pe("number")},{name:"toggles",selector:pe(["switch","input_boolean"],!0)}],"glass-pool-card":[{name:"name",selector:ge},{name:"subtitle",selector:ge},{name:"switch",selector:pe(["switch","input_boolean"])},{name:"energy",selector:pe("sensor")},{name:"color",selector:ue(["green","amber","cyan","purple","red"])}],"glass-stat-card":[{name:"entity",required:!0,selector:pe()},{name:"name",selector:ge},{name:"icon",selector:ge},{name:"color",selector:ue(["amber","green","cyan","purple","red","dim"])}],"glass-lights-card":[{name:"title",selector:ge},{name:"entities",required:!0,selector:pe("light",!0)}],"glass-scenes-card":[{name:"title",selector:ge},{name:"columns",selector:he(2,6)},{name:"scenes",required:!0,selector:pe(["scene","script","automation"],!0)}],"glass-toggle-grid-card":[{name:"title",selector:ge},{name:"columns",selector:he(2,8)},{name:"entities",required:!0,selector:pe(["light","switch","fan","input_boolean","script","scene"],!0)}],"glass-heatpump-card":[{name:"entity",required:!0,selector:pe("climate")},{name:"name",selector:ge},{name:"subtitle",selector:ge}],"glass-garage-card":[{name:"entity",required:!0,selector:pe("cover")},{name:"variant",selector:ue([{value:"full",label:"Full (animated visual)"},{value:"compact",label:"Compact tile"}])},{name:"name",selector:ge},{name:"subtitle",selector:ge}],"glass-water-chemistry-card":[{name:"title",selector:ge},{name:"metrics",selector:pe("sensor",!0)}],"glass-nav-card":[{name:"variant",selector:ue([{value:"dock",label:"Full-width dock"},{value:"pill",label:"Floating pill"}])},{name:"fixed",selector:{boolean:{}}},{name:"max_width",selector:he(320,1600)}],"glass-light-card":[{name:"entity",required:!0,selector:pe("light")},{name:"name",selector:ge},{name:"subtitle",selector:ge}],"glass-aircon-card":[{name:"entity",required:!0,selector:pe("climate")},{name:"name",selector:ge},{name:"subtitle",selector:ge}],"glass-geyser-card":[{name:"name",selector:ge},{name:"subtitle",selector:ge},{name:"power",selector:pe(["switch","input_boolean","water_heater"])},{name:"current",selector:pe("sensor")},{name:"target",selector:pe(["number","water_heater","climate"])},{name:"min_temp",selector:he(0,100)},{name:"max_temp",selector:he(0,100)},{name:"solar",selector:pe("sensor")},{name:"power_sensor",selector:pe("sensor")},{name:"solar_mode",selector:pe(["switch","input_boolean"])},{name:"modes",selector:pe(["switch","input_boolean"],!0)}],"glass-dishwasher-card":[{name:"name",selector:ge},{name:"subtitle",selector:ge},{name:"status",selector:pe("sensor")},{name:"alert",selector:pe("binary_sensor")},{name:"alert_text",selector:ge},{name:"tiles",selector:pe(["binary_sensor","sensor"],!0)},{name:"levels",selector:pe("sensor",!0)},{name:"level_max",selector:he(1,10)}]},fe={entity:"Entity",entities:"Entities",title:"Title",name:"Name (optional)",icon:"Icon (optional)",sun:"Sun entity (for sunrise/sunset)",humidity:"Humidity sensor (optional)",code:"Arm/disarm code (optional)",max:"Max flights to show",buttons:"Action buttons to show",variant:"Layout / style",code_length:"Keypad code length",today:"Solar-today energy sensor (big number)",imported:"Imported-today sensor",exported:"Exported-today sensor",saved:"Money-saved sensor",meters:"Percentage sensors to show as meters",production:"Production sensor for hourly bars (needs statistics)",subtitle:"Subtitle (e.g. room/area)",icon_color:"Icon accent colour",status:"Status sensor (drives the pill)",remaining:"Remaining-time sensor (timestamp → progress ring)",total:"Total-time sensor (minutes, for the ring %)",toggle:"Power switch (optional on/off button)",stats:"Extra sensors shown as stat tiles",door:"Door sensor",wifi:"Wi-Fi / connectivity sensor (optional)",fridge_temp:"Fridge temperature (number entity)",freezer_temp:"Freezer temperature (number entity)",toggles:"Feature switches (Express cool/mode, etc.)",switch:"Pump switch",energy:"Energy sensor (kWh)",color:"Accent colour",columns:"Columns",scenes:"Scenes / scripts to show",alert:"Alert sensor (e.g. refill needed)",alert_text:"Alert message",tiles:"Status tiles",levels:"Level sensors (shown as bars)",level_max:"Level bar maximum",power:"Power switch (on/off)",current:"Current temperature sensor",target:"Target temperature (number / thermostat)",min_temp:"Minimum temperature",max_temp:"Maximum temperature",solar:"Solar collector temperature sensor",power_sensor:"Power draw sensor (kW)",solar_mode:"Solar mode switch (toggleable)",modes:"Extra mode switches (boost, element, timer)",metrics:"Water metric sensors (pH, chlorine, …)",fixed:"Stick to bottom of screen",max_width:"Maximum width (px)",solar:"Solar power sensor",grid:"Grid power sensor (+import / −export)",battery:"Battery power sensor (+discharge / −charge)",battery_soc:"Battery charge % sensor",house:"House load sensor (optional; derived if empty)"},ve={icon:"Material Symbols name, e.g. lightbulb, garage, kitchen",code:"Only if your panel requires a code to arm/disarm"};let be=class extends dt{constructor(){super(...arguments),this._label=t=>fe[t.name]??t.name,this._helper=t=>ve[t.name]??""}setConfig(t){this._config=t}_valueChanged(t){if(t.stopPropagation(),!this._config)return;const e={...this._config,...t.detail.value,type:this._config.type};xt(this,"config-changed",{config:e})}render(){if(!this.hass||!this._config)return Y;const t=this._config.type.replace(/^custom:/,""),e=me[t];return e?q`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${e}
